...
EKe();
pve();
n5t = class KNi extends ie {
  constructor(e) {
    super();
    this.seconds = Eo.zero;
    this.nanos = 0;
    v.util.initPartial(e, this);
  }
  fromJson(e, t) {
    if (typeof e != "string") {
      throw new Error(`cannot decode google.protobuf.Duration from JSON: ${v.json.debug(e)}`);
    }
    ...
    this.seconds = Eo.parse(r);
    if (typeof i[2] == "string") {
      const s = i[2] + "0".repeat(9 - i[2].length);
      this.nanos = parseInt(s);
      if (r < 0 || Object.is(r, -0)) {
  ...
  toJson(e) {
    ...
    if (this.nanos !== 0) {
      ...
      i = "0".repeat(9 - i.length) + i;
      if (i.substring(3) === "000000") {
        i = i.substring(0, 3);
      } else if (i.substring(6) === "000") {
        i = i.substring(0, 6);
      }
      t += "." + i;
