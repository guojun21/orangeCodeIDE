...
fnu = class extends y2g {
  ...
  attach(n, e, t) {
    super.attach(n, e, t);
    if (t !== null && t instanceof sga) {
      this._network = t;
    } else {
      this._network = new sga(e ?? {});
    }
  }
  getDataAsync(n, e, t) {
  ...
  setData(n) {
    ...
    if (e && "user" in e) {
      super.setData(n, e.user);
    } else {
      CI.error("StatsigUser not found. You may be using an older server SDK version. Please upgrade your SDK or use setDataLegacy.");
    }
  }
  setDataLegacy(n, e) {
    super.setData(n, e);
