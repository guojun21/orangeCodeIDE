...
function mnu(n, e, t) {
  return (i, r) => {
    ...
    if (s == null) {
      return r ?? null;
    } else if (r != null && !QMg(s, r)) {
      CI.warn(`Parameter type mismatch. '${n}.${i}' was found to be type '${typeof s}' but fallback/return type is '${typeof r}'. See https://docs.statsig.com/client/javascript-sdk/#typed-getters`);
      return r ?? null;
    } else {
      t?.(i);
      return s;
