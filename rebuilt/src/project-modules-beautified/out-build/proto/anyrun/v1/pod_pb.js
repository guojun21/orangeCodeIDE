...
(function (n) {
  ...
  n[n.CLONE = 1] = "CLONE";
  n[n.BUILD = 2] = "BUILD";
  n[n.POST_CREATE = 3] = "POST_CREATE";
  n[n.UPDATE_CONTENT = 4] = "UPDATE_CONTENT";
  n[n.POST_START = 5] = "POST_START";
})(Vvi ||= {});
...
Yvi = class xps extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 24,
      name: "pod_awake_since",
      kind: "scalar",
      T: 4,
      opt: true
    }, {
      no: 25,
      name: "low_cardinality_labels",
      kind: "scalar",
      T: 9,
      repeated: true
    }]);
...
GGg = class Nps extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 3,
      name: "git_clone_failure",
      kind: "message",
      T: jGg,
      oneof: "details"
    }, {
      no: 4,
      name: "git_checkout_failure",
      kind: "message",
      T: zGg,
      oneof: "details"
    }]);
