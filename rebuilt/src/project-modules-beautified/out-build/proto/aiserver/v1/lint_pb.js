...
(function (n) {
  ...
  n[n.COMPILE_ERRORS = 2] = "COMPILE_ERRORS";
  n[n.CHANGE_BEHAVIOR = 3] = "CHANGE_BEHAVIOR";
  n[n.RELEVANCE = 5] = "RELEVANCE";
  n[n.USER_AWARENESS = 6] = "USER_AWARENESS";
  n[n.CORRECTNESS = 7] = "CORRECTNESS";
  n[n.CHUNKING = 8] = "CHUNKING";
  n[n.TYPO = 9] = "TYPO";
  n[n.CONFIDENCE = 10] = "CONFIDENCE";
  n[n.DISMISSED_BUGS = 11] = "DISMISSED_BUGS";
})(lvt ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.NAIVE = 1] = "NAIVE";
  n[n.COMMENT_PIPELINE = 2] = "COMMENT_PIPELINE";
  n[n.SIMPLE_BUG = 3] = "SIMPLE_BUG";
  n[n.SIMPLE_LINT_RULES = 4] = "SIMPLE_LINT_RULES";
})(uvt ||= {});
...
SOh = class Xnr extends ie {
  constructor(e) {
    super();
    this.discriminator = lvt.UNSPECIFIED;
    this.allow = false;
    this.reasoning = "";
    v.util.initPartial(e, this);
  }
...
Z8n = class eir extends ie {
  constructor(e) {
    ...
    this.generator = uvt.UNSPECIFIED;
