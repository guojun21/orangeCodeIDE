...
v.util.setEnumType(e6n, "aiserver.v1.CloudAgentEffortMode", [{
  no: 0,
  name: "CLOUD_AGENT_EFFORT_MODE_UNSPECIFIED"
}, {
  no: 1,
  name: "CLOUD_AGENT_EFFORT_MODE_STANDARD"
}, {
  no: 2,
  name: "CLOUD_AGENT_EFFORT_MODE_GRIND"
}]);
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
...
ZOh = class Mir extends ie {
  constructor(e) {
    ...
    this.language = "";
    this.fullContent = "";
    this.lastViewedTimestamp = Eo.zero;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  ...
  n[n.IN_PROGRESS_ITERATIONS = 2] = "IN_PROGRESS_ITERATIONS";
  n[n.DONE = 3] = "DONE";
  n[n.ERROR = 4] = "ERROR";
})(t6n ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.REFLECT = 1] = "REFLECT";
  n[n.LOOP_ON_LINTS = 2] = "LOOP_ON_LINTS";
  n[n.CHAT_AND_APPLY = 3] = "CHAT_AND_APPLY";
  n[n.COALESCE_GENERATIONS = 4] = "COALESCE_GENERATIONS";
  n[n.CODEBASE_CHUNKS = 5] = "CODEBASE_CHUNKS";
  n[n.SPEC_AND_APPLY = 6] = "SPEC_AND_APPLY";
  n[n.ASK_CODEBASE = 7] = "ASK_CODEBASE";
  n[n.FINETUNED_INSTRUCTIONS = 8] = "FINETUNED_INSTRUCTIONS";
  n[n.USEFUL_TYPES = 9] = "USEFUL_TYPES";
  n[n.CHAT_AND_APPLY_UNDERSPECIFIED = 10] = "CHAT_AND_APPLY_UNDERSPECIFIED";
})(i6n ||= {});
...
c5h = class rsr extends ie {
  constructor(e) {
    ...
    this.instruction = "";
    this.groundTruth = "";
    this.experiment = r6n.UNSPECIFIED;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.REFLECT = 1] = "REFLECT";
  n[n.CMD_K_ORIGINAL_RADIUS = 2] = "CMD_K_ORIGINAL_RADIUS";
  n[n.LOOP_ON_LINTS = 3] = "LOOP_ON_LINTS";
  n[n.CHAT_AND_APPLY = 4] = "CHAT_AND_APPLY";
  n[n.COMMIT_NOTES = 5] = "COMMIT_NOTES";
  n[n.COALESCE_GENERATIONS = 6] = "COALESCE_GENERATIONS";
  n[n.REWORD_INSTRUCTIONS = 7] = "REWORD_INSTRUCTIONS";
  n[n.CODEBASE_CHUNKS = 8] = "CODEBASE_CHUNKS";
  n[n.SPEC_AND_APPLY = 9] = "SPEC_AND_APPLY";
  n[n.ASK_CODEBASE = 10] = "ASK_CODEBASE";
})(r6n ||= {});
...
B5h = class Bsr extends ie {
  constructor(e) {
    super();
    this.feedbackType = Qte.UNSPECIFIED;
    this.requestId = "";
    v.util.initPartial(e, this);
  }
  static {
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.THUMBS_UP = 1] = "THUMBS_UP";
  n[n.THUMBS_DOWN = 2] = "THUMBS_DOWN";
  n[n.NEUTRAL = 3] = "NEUTRAL";
  n[n.STARS = 4] = "STARS";
})(Qte ||= {});
...
yOc = class mor extends ie {
  constructor(e) {
    ...
    this.repositories = [];
    this.codeBlocks = [];
    this.queryType = s6n.UNSPECIFIED;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.KEYWORDS = 1] = "KEYWORDS";
  n[n.EMBEDDINGS = 2] = "EMBEDDINGS";
})(s6n ||= {});
...
COc = class Kor extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 5,
      name: "use_model_parameters",
      kind: "scalar",
      T: 8,
      opt: true
    }, {
      no: 6,
      name: "include_hidden_models",
      kind: "scalar",
      T: 8,
      opt: true
    }]);
...
U9h = class Yor extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 12,
      name: "disable_unused_models_after_n_hours",
      kind: "scalar",
      T: 5,
      opt: true
    }, {
      no: 13,
      name: "upgrade_unchanged_models_after_n_hours",
      kind: "scalar",
      T: 5,
      opt: true
    }]);
...
$9h = class Xor extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 32,
      name: "cloud_agent_effort_mode",
      kind: "enum",
      T: v.getEnumType(e6n),
      opt: true
    }, {
      no: 33,
      name: "cloud_migrate_to_model",
      kind: "scalar",
      T: 9,
      opt: true
    }, {
      no: 34,
      name: "upgrade_model_id",
      kind: "scalar",
      T: 9,
      opt: true
    }, {
      ...
      no: 38,
      name: "named_model_section_index",
      kind: "scalar",
      T: 5,
      opt: true
    }, {
...
q9h = class ear extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 8,
      name: "display_name_outside_picker",
      kind: "scalar",
      T: 9,
      opt: true
    }, {
      ...
      no: 4,
      name: "is_default_max_config",
      kind: "scalar",
      T: 8,
      opt: true
    }, {
      no: 5,
      name: "is_default_non_max_config",
      kind: "scalar",
      T: 8,
      opt: true
    }, {
      ...
      no: 9,
      name: "variant_string_representation",
      kind: "scalar",
      T: 9,
      opt: true
    }]);
...
s8h = class war extends ie {
  constructor(e) {
    ...
    this.fastApplyModelType = p9t.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  ...
  n[n.DEEPSEEK = 2] = "DEEPSEEK";
  n[n.SONNET = 3] = "SONNET";
  n[n.OPUS_DIFF = 4] = "OPUS_DIFF";
  n[n.SMART_REWRITE = 5] = "SMART_REWRITE";
  n[n.GPT4 = 6] = "GPT4";
  n[n.GPT4_NOSPEC = 7] = "GPT4_NOSPEC";
  n[n.SMART_REWRITE_NOSPEC = 8] = "SMART_REWRITE_NOSPEC";
  n[n.OPUS = 9] = "OPUS";
  n[n.HAIKU = 10] = "HAIKU";
  n[n.GPT4O_NOSPEC = 11] = "GPT4O_NOSPEC";
  n[n.GPT4O_DIFF = 12] = "GPT4O_DIFF";
  n[n.CODESTRAL_REWRITE = 13] = "CODESTRAL_REWRITE";
  n[n.DEEPSEEK_33B = 14] = "DEEPSEEK_33B";
  n[n.SONNET_35_DIFF = 15] = "SONNET_35_DIFF";
  n[n.SONNET_35_REWRITE = 16] = "SONNET_35_REWRITE";
  n[n.PROMPTED_DEEPSEEK_V2 = 17] = "PROMPTED_DEEPSEEK_V2";
  n[n.CODESTRAL_REWRITE_OLD = 18] = "CODESTRAL_REWRITE_OLD";
  n[n.CODESTRAL_REWRITE_FP16 = 19] = "CODESTRAL_REWRITE_FP16";
  n[n.DEEPSEEK_33B_V2 = 20] = "DEEPSEEK_33B_V2";
  n[n.CODESTRAL_V4 = 21] = "CODESTRAL_V4";
  n[n.CODESTRAL_V5 = 22] = "CODESTRAL_V5";
  n[n.CODESTRAL_V6 = 23] = "CODESTRAL_V6";
  n[n.CODESTRAL_V7 = 24] = "CODESTRAL_V7";
})(p9t ||= {});
...
w8h = class Uar extends ie {
  constructor(e) {
    super();
    this.userFeedback = l6n.UNSPECIFIED;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.CORRECT = 1] = "CORRECT";
  n[n.INCORRECT = 2] = "INCORRECT";
  n[n.OTHER = 3] = "OTHER";
})(l6n ||= {});
...
a6h = class Rcr extends ie {
  constructor(e) {
    super();
    this.promptType = u6n.UNSPECIFIED;
    this.query = "";
    this.bucketId = "";
    this.queryStrategy = "";
    this.tokenLimit = 0;
    this.rerankingStrategy = d6n.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.DISTANCE_ONLY = 1] = "DISTANCE_ONLY";
  n[n.GPT4_RELEVANCE = 2] = "GPT4_RELEVANCE";
})(d6n ||= {});
...
FOc = class $lr extends ie {
  constructor(e) {
    super();
    this.humanReadableTitle = "";
    this.taskStatus = h9t.UNSPECIFIED;
...
gUh = class jlr extends ie {
  constructor(e) {
    super();
    this.feedback = "";
    this.feedbackType = h6n.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.LOW_PRIORITY = 1] = "LOW_PRIORITY";
  n[n.HIGH_PRIORITY = 2] = "HIGH_PRIORITY";
})(h6n ||= {});
...
(function (n) {
  ...
  n[n.URGENT = 3] = "URGENT";
  n[n.CRASH = 4] = "CRASH";
  n[n.CONNECTION_ERROR = 5] = "CONNECTION_ERROR";
  n[n.IDEA = 6] = "IDEA";
  n[n.MISC_AUTOMATIC_ERROR = 7] = "MISC_AUTOMATIC_ERROR";
})(RW ||= {});
...
MUh = class pur extends ie {
  constructor(e) {
    ...
    this.featureType = y5n.UNSPECIFIED;
    this.relativeWorkspacePath = "";
    this.contents = "";
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.CANCELLED = 1] = "CANCELLED";
  n[n.ACCEPTED = 2] = "ACCEPTED";
  n[n.REJECTED = 3] = "REJECTED";
  n[n.FOLLOWED_UP = 4] = "FOLLOWED_UP";
  n[n.REPROMPTED = 5] = "REPROMPTED";
})(m6n ||= {});
...
b$h = class tdr extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 4,
      name: "conversion_model_override",
      kind: "scalar",
      T: 9
    }]);
  }
...
k$h = class fdr extends ie {
  constructor(e) {
    super();
    this.sampleStart = Eo.zero;
    this.sampleEnd = Eo.zero;
    this.numSubsamples = 0;
    this.windowSeq = Eo.zero;
    this.sessionId = "";
    this.rows = [];
    v.util.initPartial(e, this);
  }
