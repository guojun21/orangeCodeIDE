...
(function (n) {
  ...
  n[n.ACCEPT = 1] = "ACCEPT";
  n[n.REJECT = 2] = "REJECT";
  n[n.PARTIAL_ACCEPT = 3] = "PARTIAL_ACCEPT";
})(YKe ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.LINE_CHANGE = 1] = "LINE_CHANGE";
  n[n.TYPING = 2] = "TYPING";
  n[n.OPTION_HOLD = 3] = "OPTION_HOLD";
  n[n.LINTER_ERRORS = 4] = "LINTER_ERRORS";
  n[n.PARAMETER_HINTS = 5] = "PARAMETER_HINTS";
  n[n.CURSOR_PREDICTION = 6] = "CURSOR_PREDICTION";
  n[n.MANUAL_TRIGGER = 7] = "MANUAL_TRIGGER";
  n[n.EDITOR_CHANGE = 8] = "EDITOR_CHANGE";
  n[n.LSP_SUGGESTIONS = 9] = "LSP_SUGGESTIONS";
})(Gte ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.LOTS_OF_ADDED_TEXT = 1] = "LOTS_OF_ADDED_TEXT";
  n[n.DUPLICATING_LINE_AFTER_SUGGESTION = 2] = "DUPLICATING_LINE_AFTER_SUGGESTION";
  n[n.DUPLICATING_MULTIPLE_LINES_AFTER_SUGGESTION = 3] = "DUPLICATING_MULTIPLE_LINES_AFTER_SUGGESTION";
  n[n.REVERTING_USER_CHANGE = 4] = "REVERTING_USER_CHANGE";
  n[n.OUTPUT_EXTENDS_BEYOND_RANGE_AND_IS_REPEATED = 5] = "OUTPUT_EXTENDS_BEYOND_RANGE_AND_IS_REPEATED";
  n[n.SUGGESTING_RECENTLY_REJECTED_EDIT = 6] = "SUGGESTING_RECENTLY_REJECTED_EDIT";
})(j9e ||= {});
...
b2h = class iXi extends ie {
  constructor(e) {
    ...
    this.requestId = "";
    this.sessionId = "";
    this.responseType = M8n.UNSPECIFIED;
    this.modelCodeName = "";
...
(function (n) {
  ...
  n[n.GOOD = 1] = "GOOD";
  n[n.BAD = 2] = "BAD";
  n[n.BAD_CONTEXT = 3] = "BAD_CONTEXT";
  n[n.BAD_REASONING = 4] = "BAD_REASONING";
  n[n.BAD_STUPID_MISTAKE = 5] = "BAD_STUPID_MISTAKE";
  n[n.BAD_FORMATTING = 6] = "BAD_FORMATTING";
  n[n.BAD_RANGE = 7] = "BAD_RANGE";
  n[n.GOOD_PREDICTION = 8] = "GOOD_PREDICTION";
  n[n.BAD_FALSE_POSITIVE_TRIGGER = 9] = "BAD_FALSE_POSITIVE_TRIGGER";
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.ALWAYS_ON = 1] = "ALWAYS_ON";
  n[n.ACCEPT = 2] = "ACCEPT";
  n[n.UNDO = 3] = "UNDO";
  n[n.EDITOR_CHANGE = 4] = "EDITOR_CHANGE";
})(avt ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.FILE_TOO_BIG = 1] = "FILE_TOO_BIG";
  n[n.FILE_DISPOSED = 2] = "FILE_DISPOSED";
  n[n.CHANGE_TOO_BIG = 3] = "CHANGE_TOO_BIG";
})(cvt ||= {});
...
oFh = class ier extends ie {
  constructor(e) {
    super();
    this.heuristic = U8n.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.LINT_OVERLAP = 1] = "LINT_OVERLAP";
  n[n.LINES_MISMATCH = 2] = "LINES_MISMATCH";
})(U8n ||= {});
...
(function (n) {
  ...
  n[n.TOO_RECENT = 2] = "TOO_RECENT";
  n[n.UNVIEWED_BUG_REPORTS = 3] = "UNVIEWED_BUG_REPORTS";
  n[n.NOT_IN_GIT_REPO = 4] = "NOT_IN_GIT_REPO";
  n[n.DEFAULT_BRANCH_IS_NOT_CURRENT_BRANCH = 5] = "DEFAULT_BRANCH_IS_NOT_CURRENT_BRANCH";
  n[n.NO_GIT_USER = 6] = "NO_GIT_USER";
  n[n.NO_LAST_COMMIT = 7] = "NO_LAST_COMMIT";
  n[n.LAST_COMMIT_NOT_MADE_BY_USER = 8] = "LAST_COMMIT_NOT_MADE_BY_USER";
  n[n.LAST_COMMIT_TOO_OLD = 9] = "LAST_COMMIT_TOO_OLD";
  n[n.DIFF_TOO_LONG = 10] = "DIFF_TOO_LONG";
  n[n.DIFF_TOO_SHORT = 11] = "DIFF_TOO_SHORT";
  n[n.TELEMETRY_UNHEALTHY = 12] = "TELEMETRY_UNHEALTHY";
})($8n ||= {});
...
yFh = class ber extends ie {
  constructor(e) {
    super();
    this.requestType = z9e.UNSPECIFIED;
    this.requestId = "";
    this.source = _z.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  ...
  n[n.CMDK = 2] = "CMDK";
  n[n.APPLY = 3] = "APPLY";
  n[n.COMPOSER = 4] = "COMPOSER";
  n[n.TASK = 5] = "TASK";
  n[n.CODE_INTERPRETER = 6] = "CODE_INTERPRETER";
  n[n.INTERPRETER_EXECUTION = 7] = "INTERPRETER_EXECUTION";
  n[n.BUGBOT = 8] = "BUGBOT";
})(_z ||= {});
...
q8n = class Per extends ie {
  constructor(e) {
    ...
    this.privacyModeStatus = XKe.UNSPECIFIED;
    this.events = [];
    this.timeOrigin = 0;
    v.util.initPartial(e, this);
  }
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.PRIVACY_ENABLED = 1] = "PRIVACY_ENABLED";
  n[n.IMPLICIT_NO_PRIVACY = 2] = "IMPLICIT_NO_PRIVACY";
  n[n.EXPLICIT_NO_PRIVACY = 3] = "EXPLICIT_NO_PRIVACY";
})(XKe ||= {});
...
(function (n) {
  ...
  n[n.UNVALIDATED = 2] = "UNVALIDATED";
  n[n.INCORRECT = 3] = "INCORRECT";
})(H8n ||= {});
...
KFh = class ttr extends ie {
  constructor(e) {
    ...
    this.repoOwner = "";
    this.repoName = "";
    this.eventType = Wte.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
(function (n) {
  ...
  n[n.INDEXING_SETUP = 3] = "INDEXING_SETUP";
  n[n.INDEXING_INIT_FROM_SIMILAR_CODEBASE = 4] = "INDEXING_INIT_FROM_SIMILAR_CODEBASE";
  n[n.PAUSED = 5] = "PAUSED";
  n[n.INDEXING = 6] = "INDEXING";
  n[n.ERROR = 7] = "ERROR";
  n[n.NOT_AUTO_INDEXING = 8] = "NOT_AUTO_INDEXING";
  n[n.NOT_INDEXED = 9] = "NOT_INDEXED";
})(Wte ||= {});
...
YFh = class ntr extends ie {
  constructor(e) {
    super();
    this.operationType = J8n.UNSPECIFIED;
    this.repositoryPath = "";
...
ZFh = class itr extends ie {
  constructor(e) {
    super();
    this.eventType = dke.UNSPECIFIED;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.APPLY_TO_MAIN = 1] = "APPLY_TO_MAIN";
  n[n.UNDO_APPLY = 2] = "UNDO_APPLY";
  n[n.VIEW_SUBCOMPOSER = 3] = "VIEW_SUBCOMPOSER";
})(dke ||= {});
v.util.setEnumType(dke, "aiserver.v1.WorktreeEvent.EventType", [{
  ...
  no: 3,
  name: "EVENT_TYPE_VIEW_SUBCOMPOSER"
}]);
