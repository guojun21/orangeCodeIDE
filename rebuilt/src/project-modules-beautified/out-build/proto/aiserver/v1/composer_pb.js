...
Ka();
qp();
BIh = class K$i extends ie {
  constructor(e) {
    super();
    this.type = ko.UNSPECIFIED;
    this.data = {
      case: undefined
    };
...
(function (n) {
  ...
  n[n.LOOP_ON_LINTS = 1] = "LOOP_ON_LINTS";
  n[n.LOOP_ON_TESTS = 2] = "LOOP_ON_TESTS";
  n[n.MEGA_PLANNER = 3] = "MEGA_PLANNER";
  n[n.LOOP_ON_COMMAND = 4] = "LOOP_ON_COMMAND";
  n[n.TOOL_CALL = 5] = "TOOL_CALL";
  n[n.DIFF_REVIEW = 6] = "DIFF_REVIEW";
  n[n.CONTEXT_PICKING = 7] = "CONTEXT_PICKING";
  n[n.EDIT_TRAIL = 8] = "EDIT_TRAIL";
  n[n.AUTO_CONTEXT = 9] = "AUTO_CONTEXT";
  n[n.CONTEXT_PLANNER = 10] = "CONTEXT_PLANNER";
  n[n.DIFF_HISTORY = 11] = "DIFF_HISTORY";
  n[n.REMEMBER_THIS = 12] = "REMEMBER_THIS";
  n[n.DECOMPOSER = 13] = "DECOMPOSER";
  n[n.USES_CODEBASE = 14] = "USES_CODEBASE";
  n[n.TOOL_FORMER = 15] = "TOOL_FORMER";
  n[n.CURSOR_RULES = 16] = "CURSOR_RULES";
  n[n.TOKEN_COUNTER = 17] = "TOKEN_COUNTER";
  n[n.USAGE_DATA = 18] = "USAGE_DATA";
  n[n.CHIMES = 19] = "CHIMES";
  n[n.CODE_DECAY_TRACKER = 20] = "CODE_DECAY_TRACKER";
  n[n.BACKGROUND_COMPOSER = 21] = "BACKGROUND_COMPOSER";
  n[n.SUMMARIZATION = 22] = "SUMMARIZATION";
  n[n.AI_CODE_TRACKING = 23] = "AI_CODE_TRACKING";
  n[n.QUEUING = 24] = "QUEUING";
  n[n.MEMORIES = 25] = "MEMORIES";
  n[n.RCP_LOGS = 26] = "RCP_LOGS";
  n[n.KNOWLEDGE_FETCH = 27] = "KNOWLEDGE_FETCH";
  n[n.SLACK_INTEGRATION = 28] = "SLACK_INTEGRATION";
  n[n.SUB_COMPOSER = 29] = "SUB_COMPOSER";
  n[n.THINKING = 30] = "THINKING";
  n[n.CONTEXT_WINDOW = 31] = "CONTEXT_WINDOW";
  n[n.ONLINE_METRICS = 32] = "ONLINE_METRICS";
  n[n.NOTIFICATIONS = 33] = "NOTIFICATIONS";
  n[n.SPEC = 34] = "SPEC";
  n[n.BROWSER_AGENT = 35] = "BROWSER_AGENT";
})(ko ||= {});
v.util.setEnumType(ko, "aiserver.v1.ComposerCapabilityRequest.ComposerCapabilityType", [{
  ...
  no: 35,
  name: "COMPOSER_CAPABILITY_TYPE_BROWSER_AGENT"
}]);
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.ADD_FILE_TO_CONTEXT = 1] = "ADD_FILE_TO_CONTEXT";
  n[n.ITERATE = 3] = "ITERATE";
  n[n.REMOVE_FILE_FROM_CONTEXT = 4] = "REMOVE_FILE_FROM_CONTEXT";
  n[n.SEMANTIC_SEARCH_CODEBASE = 5] = "SEMANTIC_SEARCH_CODEBASE";
})(VY ||= {});
