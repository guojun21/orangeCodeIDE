...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.EDIT = 1] = "EDIT";
  n[n.GENERATE = 2] = "GENERATE";
  n[n.INLINE_LONG_COMPLETION = 3] = "INLINE_LONG_COMPLETION";
})(y5n ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.VOYAGE_CODE_2 = 1] = "VOYAGE_CODE_2";
  n[n.TEXT_EMBEDDINGS_LARGE_3 = 2] = "TEXT_EMBEDDINGS_LARGE_3";
  n[n.QWEN_1_5B_CUSTOM = 3] = "QWEN_1_5B_CUSTOM";
  n[n.MOCK_CHUNKER_ERROR = 4] = "MOCK_CHUNKER_ERROR";
  n[n.QWEN_1_5B_0618_CUSTOM = 5] = "QWEN_1_5B_0618_CUSTOM";
  n[n.QWEN_1_5B_0618_FP8_MM_CUSTOM = 6] = "QWEN_1_5B_0618_FP8_MM_CUSTOM";
})(AT ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.NAME_STATUS = 1] = "NAME_STATUS";
  n[n.NAME_STATUS_AND_NUMSTAT = 2] = "NAME_STATUS_AND_NUMSTAT";
  n[n.FILE_DIFFS = 3] = "FILE_DIFFS";
  n[n.DIFFS_WITH_BEFORE_AND_AFTER = 4] = "DIFFS_WITH_BEFORE_AND_AFTER";
})(Dbt ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.DIFF_TO_HEAD = 1] = "DIFF_TO_HEAD";
  n[n.DIFF_FROM_BRANCH_TO_MAIN = 2] = "DIFF_FROM_BRANCH_TO_MAIN";
})(nae ||= {});
...
r5t = class c2i extends ie {
  constructor(e) {
    super();
    this.messageType = _5n.UNSPECIFIED;
    this.content = "";
    v.util.initPartial(e, this);
  }
  static {
...
(function (n) {
  ...
  n[n.FILE = 1] = "FILE";
  n[n.MODULE = 2] = "MODULE";
  n[n.NAMESPACE = 3] = "NAMESPACE";
  n[n.PACKAGE = 4] = "PACKAGE";
  n[n.CLASS = 5] = "CLASS";
  n[n.METHOD = 6] = "METHOD";
  n[n.PROPERTY = 7] = "PROPERTY";
  n[n.FIELD = 8] = "FIELD";
  n[n.CONSTRUCTOR = 9] = "CONSTRUCTOR";
  n[n.ENUM = 10] = "ENUM";
  n[n.INTERFACE = 11] = "INTERFACE";
  n[n.FUNCTION = 12] = "FUNCTION";
  n[n.VARIABLE = 13] = "VARIABLE";
  n[n.CONSTANT = 14] = "CONSTANT";
  n[n.STRING = 15] = "STRING";
  n[n.NUMBER = 16] = "NUMBER";
  n[n.BOOLEAN = 17] = "BOOLEAN";
  n[n.ARRAY = 18] = "ARRAY";
  n[n.OBJECT = 19] = "OBJECT";
  n[n.KEY = 20] = "KEY";
  n[n.NULL = 21] = "NULL";
  n[n.ENUM_MEMBER = 22] = "ENUM_MEMBER";
  n[n.STRUCT = 23] = "STRUCT";
  n[n.EVENT = 24] = "EVENT";
  n[n.OPERATOR = 25] = "OPERATOR";
  n[n.TYPE_PARAMETER = 26] = "TYPE_PARAMETER";
})(S5n ||= {});
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.BAD_API_KEY = 1] = "BAD_API_KEY";
  n[n.BAD_USER_API_KEY = 42] = "BAD_USER_API_KEY";
  n[n.NOT_LOGGED_IN = 2] = "NOT_LOGGED_IN";
  n[n.INVALID_AUTH_ID = 3] = "INVALID_AUTH_ID";
  n[n.NOT_HIGH_ENOUGH_PERMISSIONS = 4] = "NOT_HIGH_ENOUGH_PERMISSIONS";
  n[n.AGENT_REQUIRES_LOGIN = 18] = "AGENT_REQUIRES_LOGIN";
  n[n.BAD_MODEL_NAME = 5] = "BAD_MODEL_NAME";
  n[n.NOT_FOUND = 39] = "NOT_FOUND";
  n[n.DEPRECATED = 40] = "DEPRECATED";
  n[n.USER_NOT_FOUND = 6] = "USER_NOT_FOUND";
  n[n.FREE_USER_RATE_LIMIT_EXCEEDED = 7] = "FREE_USER_RATE_LIMIT_EXCEEDED";
  n[n.PRO_USER_RATE_LIMIT_EXCEEDED = 8] = "PRO_USER_RATE_LIMIT_EXCEEDED";
  n[n.FREE_USER_USAGE_LIMIT = 9] = "FREE_USER_USAGE_LIMIT";
  n[n.PRO_USER_USAGE_LIMIT = 10] = "PRO_USER_USAGE_LIMIT";
  n[n.RESOURCE_EXHAUSTED = 41] = "RESOURCE_EXHAUSTED";
  n[n.AUTH_TOKEN_NOT_FOUND = 11] = "AUTH_TOKEN_NOT_FOUND";
  n[n.AUTH_TOKEN_EXPIRED = 12] = "AUTH_TOKEN_EXPIRED";
  n[n.OPENAI = 13] = "OPENAI";
  n[n.OPENAI_RATE_LIMIT_EXCEEDED = 14] = "OPENAI_RATE_LIMIT_EXCEEDED";
  n[n.OPENAI_ACCOUNT_LIMIT_EXCEEDED = 15] = "OPENAI_ACCOUNT_LIMIT_EXCEEDED";
  n[n.TASK_UUID_NOT_FOUND = 16] = "TASK_UUID_NOT_FOUND";
  n[n.TASK_NO_PERMISSIONS = 17] = "TASK_NO_PERMISSIONS";
  n[n.AGENT_ENGINE_NOT_FOUND = 19] = "AGENT_ENGINE_NOT_FOUND";
  n[n.MAX_TOKENS = 20] = "MAX_TOKENS";
  n[n.PRO_USER_ONLY = 23] = "PRO_USER_ONLY";
  n[n.API_KEY_NOT_SUPPORTED = 24] = "API_KEY_NOT_SUPPORTED";
  n[n.USER_ABORTED_REQUEST = 21] = "USER_ABORTED_REQUEST";
  n[n.TIMEOUT = 25] = "TIMEOUT";
  n[n.GENERIC_RATE_LIMIT_EXCEEDED = 22] = "GENERIC_RATE_LIMIT_EXCEEDED";
  n[n.SLASH_EDIT_FILE_TOO_LONG = 26] = "SLASH_EDIT_FILE_TOO_LONG";
  n[n.FILE_UNSUPPORTED = 27] = "FILE_UNSUPPORTED";
  n[n.GPT_4_VISION_PREVIEW_RATE_LIMIT = 28] = "GPT_4_VISION_PREVIEW_RATE_LIMIT";
  n[n.CUSTOM_MESSAGE = 29] = "CUSTOM_MESSAGE";
  n[n.OUTDATED_CLIENT = 30] = "OUTDATED_CLIENT";
  n[n.CLAUDE_IMAGE_TOO_LARGE = 31] = "CLAUDE_IMAGE_TOO_LARGE";
  n[n.GITGRAPH_NOT_FOUND = 32] = "GITGRAPH_NOT_FOUND";
  n[n.FILE_NOT_FOUND = 33] = "FILE_NOT_FOUND";
  n[n.API_KEY_RATE_LIMIT = 34] = "API_KEY_RATE_LIMIT";
  n[n.DEBOUNCED = 35] = "DEBOUNCED";
  n[n.BAD_REQUEST = 36] = "BAD_REQUEST";
  n[n.REPOSITORY_SERVICE_REPOSITORY_IS_NOT_INITIALIZED = 37] = "REPOSITORY_SERVICE_REPOSITORY_IS_NOT_INITIALIZED";
  n[n.UNAUTHORIZED = 38] = "UNAUTHORIZED";
  n[n.CONVERSATION_TOO_LONG = 43] = "CONVERSATION_TOO_LONG";
  n[n.USAGE_PRICING_REQUIRED = 44] = "USAGE_PRICING_REQUIRED";
  n[n.USAGE_PRICING_REQUIRED_CHANGEABLE = 45] = "USAGE_PRICING_REQUIRED_CHANGEABLE";
  n[n.GITHUB_NO_USER_CREDENTIALS = 46] = "GITHUB_NO_USER_CREDENTIALS";
  n[n.GITHUB_USER_NO_ACCESS = 47] = "GITHUB_USER_NO_ACCESS";
  n[n.GITHUB_APP_NO_ACCESS = 48] = "GITHUB_APP_NO_ACCESS";
  n[n.GITHUB_MULTIPLE_OWNERS = 49] = "GITHUB_MULTIPLE_OWNERS";
  n[n.RATE_LIMITED = 50] = "RATE_LIMITED";
  n[n.RATE_LIMITED_CHANGEABLE = 51] = "RATE_LIMITED_CHANGEABLE";
  n[n.CUSTOM = 52] = "CUSTOM";
  n[n.HOOKS_BLOCKED = 53] = "HOOKS_BLOCKED";
  n[n.SUSPICIOUS_USAGE_BLOCKED = 54] = "SUSPICIOUS_USAGE_BLOCKED";
  n[n.EXTENSION_HOST_TIMEOUT = 55] = "EXTENSION_HOST_TIMEOUT";
  n[n.NETWORK_ERROR = 56] = "NETWORK_ERROR";
  n[n.PROVIDER_ERROR = 57] = "PROVIDER_ERROR";
  n[n.MODEL_BLOCKED = 58] = "MODEL_BLOCKED";
})(yc ||= {});
