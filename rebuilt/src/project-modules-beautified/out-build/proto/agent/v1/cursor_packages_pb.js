...
(function (n) {
  ...
  n[n.CURSOR_PROJECT = 1] = "CURSOR_PROJECT";
  n[n.CURSOR_PERSONAL = 2] = "CURSOR_PERSONAL";
  n[n.CLAUDE_SKILL = 3] = "CLAUDE_SKILL";
  n[n.CLAUDE_PLUGIN = 4] = "CLAUDE_PLUGIN";
})(Zbt ||= {});
v.util.setEnumType(Zbt, "agent.v1.PackageType", [{
  ...
  no: 1,
  name: "PACKAGE_TYPE_CURSOR_PROJECT"
}, {
  no: 2,
  name: "PACKAGE_TYPE_CURSOR_PERSONAL"
}, {
  no: 3,
  name: "PACKAGE_TYPE_CLAUDE_SKILL"
}, {
  no: 4,
  name: "PACKAGE_TYPE_CLAUDE_PLUGIN"
}]);
