...
(function (n) {
  ...
  n[n.CANCEL = 1] = "CANCEL";
  n[n.BACKGROUND = 2] = "BACKGROUND";
})(x5n ||= {});
v.util.setEnumType(x5n, "agent.v1.TimeoutBehavior", [{
  no: 0,
  name: "TIMEOUT_BEHAVIOR_UNSPECIFIED"
}, {
  no: 1,
  name: "TIMEOUT_BEHAVIOR_CANCEL"
}, {
  no: 2,
  name: "TIMEOUT_BEHAVIOR_BACKGROUND"
}]);
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.USER_ABORT = 1] = "USER_ABORT";
  n[n.TIMEOUT = 2] = "TIMEOUT";
})(T5n ||= {});
v.util.setEnumType(T5n, "agent.v1.ShellAbortReason", [{
  no: 0,
  name: "SHELL_ABORT_REASON_UNSPECIFIED"
}, {
  no: 1,
  name: "SHELL_ABORT_REASON_USER_ABORT"
}, {
  no: 2,
  name: "SHELL_ABORT_REASON_TIMEOUT"
}]);
...
RRc = class tFi extends ie {
  constructor(e) {
    super();
    this.commands = [];
    this.suggestedSandboxMode = D5n.UNSPECIFIED;
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.SANDBOX = 1] = "SANDBOX";
  n[n.NO_SANDBOX = 2] = "NO_SANDBOX";
  n[n.UNDETERMINED = 3] = "UNDETERMINED";
})(D5n ||= {});
v.util.setEnumType(D5n, "agent.v1.CommandClassifierResult.SuggestedSandboxMode", [{
  no: 0,
  name: "SUGGESTED_SANDBOX_MODE_UNSPECIFIED"
}, {
  no: 1,
  name: "SUGGESTED_SANDBOX_MODE_SANDBOX"
}, {
  no: 2,
  name: "SUGGESTED_SANDBOX_MODE_NO_SANDBOX"
}, {
  no: 3,
  name: "SUGGESTED_SANDBOX_MODE_UNDETERMINED"
}]);
...
o5t = class iFi extends ie {
  constructor(e) {
    ...
    this.timeoutBehavior = x5n.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
