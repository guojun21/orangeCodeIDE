...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.SHELL = 1] = "SHELL";
  n[n.SUBAGENT = 2] = "SUBAGENT";
})(nvt ||= {});
v.util.setEnumType(nvt, "agent.v1.BackgroundTaskKind", [{
  no: 0,
  name: "BACKGROUND_TASK_KIND_UNSPECIFIED"
}, {
  no: 1,
  name: "BACKGROUND_TASK_KIND_SHELL"
}, {
  no: 2,
  name: "BACKGROUND_TASK_KIND_SUBAGENT"
}]);
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.SUCCESS = 1] = "SUCCESS";
  n[n.ERROR = 2] = "ERROR";
  n[n.ABORTED = 3] = "ABORTED";
})(zKe ||= {});
v.util.setEnumType(zKe, "agent.v1.BackgroundTaskStatus", [{
  no: 0,
  name: "BACKGROUND_TASK_STATUS_UNSPECIFIED"
}, {
  no: 1,
  name: "BACKGROUND_TASK_STATUS_SUCCESS"
}, {
  no: 2,
  name: "BACKGROUND_TASK_STATUS_ERROR"
}, {
  no: 3,
...
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
  n[n.PLAN_EXECUTION = 1] = "PLAN_EXECUTION";
  n[n.COMMIT_REMINDER = 2] = "COMMIT_REMINDER";
  n[n.BACKGROUND_TASK_COMPLETION = 3] = "BACKGROUND_TASK_COMPLETION";
})($9e ||= {});
v.util.setEnumType($9e, "agent.v1.SimulatedMsgReason", [{
  ...
  no: 1,
  name: "SIMULATED_MSG_REASON_PLAN_EXECUTION"
}, {
  no: 2,
  name: "SIMULATED_MSG_REASON_COMMIT_REMINDER"
}, {
  no: 3,
  name: "SIMULATED_MSG_REASON_BACKGROUND_TASK_COMPLETION"
}]);
(function (n) {
  n[n.UNSPECIFIED = 0] = "UNSPECIFIED";
...
lN = class ZWi extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 31,
      name: "write_shell_stdin_tool_call",
      kind: "message",
      T: m2c,
      oneof: "tool"
    }, {
      no: 32,
      name: "reflect_tool_call",
      kind: "message",
      T: OBh,
      oneof: "tool"
    }, {
      no: 33,
      name: "setup_vm_environment_tool_call",
      kind: "message",
      T: $Bh,
      oneof: "tool"
    }, {
      no: 34,
      name: "truncated_tool_call",
      kind: "message",
      T: uPh,
      oneof: "tool"
    }, {
      no: 35,
      name: "start_grind_execution_tool_call",
      kind: "message",
      T: WBh,
      oneof: "tool"
    }, {
      no: 36,
      name: "start_grind_planning_tool_call",
      kind: "message",
      T: KBh,
      oneof: "tool"
    }, {
      no: 37,
      name: "web_fetch_tool_call",
      kind: "message",
      T: b2c,
      oneof: "tool"
    }, {
      no: 38,
      name: "report_bugfix_results_tool_call",
      kind: "message",
      T: wIh,
      oneof: "tool"
    }, {
      no: 39,
      name: "ai_attribution_tool_call",
      kind: "message",
      T: nxh,
      oneof: "tool"
    }, {
      no: 40,
      name: "pr_management_tool_call",
      kind: "message",
      T: hRh,
      oneof: "tool"
    }, {
      no: 41,
      name: "mcp_auth_tool_call",
      kind: "message",
      T: vRh,
      oneof: "tool"
    }, {
      no: 42,
      name: "await_tool_call",
      kind: "message",
      T: xRh,
      oneof: "tool"
    }]);
...
SF = class oQi extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 10,
      name: "cancel_subagent_action",
      kind: "message",
      T: tFc,
      oneof: "action"
    }, {
      no: 12,
      name: "background_task_completion_action",
      kind: "message",
      T: X2c,
      oneof: "action"
    }, {
      no: 11,
      name: "triggering_auth_id",
      kind: "scalar",
      T: 9,
      opt: true
    }]);
...
eFc = class cQi extends ie {
  constructor(e) {
    super();
    this.taskId = "";
    this.kind = nvt.UNSPECIFIED;
    this.status = zKe.UNSPECIFIED;
    this.title = "";
    v.util.initPartial(e, this);
  }
  static {
...
g8n = class bQi extends ie {
  constructor(e) {
    super();
    this.executionMode = vz.UNSPECIFIED;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
yPh = class FQi extends ie {
  constructor(e) {
    super();
    this.createdTimestampMs = Eo.zero;
    this.lastUsedTimestampMs = Eo.zero;
    v.util.initPartial(e, this);
  }
  static {
    this.runtime = v;
...
fFc = class mji extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 7,
      name: "create_plan_request_query",
      kind: "message",
      T: uBh,
      oneof: "query"
    }, {
      no: 8,
      name: "setup_vm_environment_args",
      kind: "message",
      T: p2c,
      oneof: "query"
    }, {
      no: 9,
      name: "web_fetch_request_query",
      kind: "message",
      T: eRh,
      oneof: "query"
    }, {
      no: 10,
      name: "pr_management_request_query",
      kind: "message",
      T: mRh,
      oneof: "query"
    }, {
      no: 11,
      name: "mcp_auth_request_query",
      kind: "message",
      T: ARh,
      oneof: "query"
    }]);
...
NPh = class pji extends ie {
  ...
  static {
    this.fields = v.util.newFieldList(() => [{
      ...
      no: 7,
      name: "create_plan_request_response",
      kind: "message",
      T: dBh,
      oneof: "result"
    }, {
      no: 8,
      name: "setup_vm_environment_result",
      kind: "message",
      T: g2c,
      oneof: "result"
    }, {
      no: 9,
      name: "web_fetch_request_response",
      kind: "message",
      T: tRh,
      oneof: "result"
    }, {
      no: 10,
      name: "pr_management_result",
      kind: "message",
      T: A2c,
      oneof: "result"
    }, {
      no: 11,
      name: "mcp_auth_request_response",
      kind: "message",
      T: yRh,
      oneof: "result"
    }]);
...
OPh = class bji extends ie {
  constructor(e) {
    ...
    this.contextTokens = Eo.zero;
    this.contextWindowSize = Eo.zero;
    this.messageCount = 0;
