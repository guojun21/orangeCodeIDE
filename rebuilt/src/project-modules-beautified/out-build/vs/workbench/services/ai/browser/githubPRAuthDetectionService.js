...
sB();
Mrt();
p0u = xi("githubPRAuthDetectionService");
KIa = class extends at {
  constructor(e, t, i) {
    super();
    this.gitContextService = e;
    this.githubPRService = t;
    this.composerNotificationService = i;
  }
  async checkAndShowGitHubAuthNotification(e, t, i) {
    try {
      if (await this.githubPRService.hasGitHubConnection()) {
        return;
      }
...
KIa = __decorate([__param(0, AE), __param(1, EX), __param(2, g$e)], KIa);
Vi(p0u, KIa, 1);
