...
Mp();
qg();
xqe = xi("WorkbenchAssignmentService");
Wxf = class {
  constructor(n) {
    this.memento = n;
    this.mementoObj = n.getMemento(-1, 1);
  }
  async getValue(n, e) {
...
Qxf = class {
  ...
  setSharedProperty(n, e) {
    if (n === this.productService.tasConfig?.assignmentContextTelemetryPropertyName) {
      this._lastAssignmentContext = e;
    }
    this.telemetryService.setExperimentProperty(n, e);
  }
  postEvent(n, e) {
    const t = {};
...
yCa = class extends Gxf {
  constructor(e, t, i, r, s) {
    super(e.machineId, i, r, s, new Qxf(e, r), new Wxf(new EM("experiment.service.memento", t)));
...
yCa = __decorate([__param(0, ea), __param(1, Hi), __param(2, Fn), __param(3, za), __param(4, lg)], yCa);
Vi(xqe, yCa, 1);
jxf = Di.as(Dh.Configuration);
jxf.registerConfiguration({
  ...vQ,
  properties: {
    "workbench.enableExperiments": {
      type: "boolean",
      description: _(13661, null),
      default: true,
      scope: 1,
      restricted: true,
