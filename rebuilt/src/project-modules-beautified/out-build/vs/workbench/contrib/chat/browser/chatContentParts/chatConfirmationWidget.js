...
hSi = class extends at {
    ...
    constructor(e, t, i, r, s, o, a) {
        ...
        this._domNode = l.root;
        this.markdownRenderer = this.instantiationService.createInstance(sL, {});
        if (i) {
            const d = Ua(this, false);
            const m = this._register(new pw(l.expando, {}));
            this._register(Oc(p => {
                const g = d.read(p);
                m.icon = g ? Be.chevronDown : Be.chevronRight;
                l.message.classList.toggle("hidden", !g);
        ...
        l.title.append(u.element);
        this.messageElement = l.message;
        t.forEach(d => {
            const m = {
                ...lE,
                secondary: d.isSecondary,
                title: d.tooltip
            };
            let p;
            if (d.moreActions) {
                p = new Cbt(l.buttonsContainer, {
                    ...m,
                    contextMenuProvider: s,
                    addPrimaryActionToDropdown: false,
                    actions: d.moreActions.map(g => this._register(new Hs(g.label, g.label, undefined, true, () => {
                        this._onDidClick.fire(g);
                        return Promise.resolve();
                    })))
                });
            } else {
                p = new pw(l.buttonsContainer, m);
            }
            this._register(p);
            p.label = d.label;
            this._register(p.onDidClick(() => this._onDidClick.fire(d)));
        });
    }
    renderMessage(e) {
...
hSi = __decorate([__param(3, ln), __param(4, kc), __param(5, Fn), __param(6, wd)], hSi);
mSi = class extends hSi {
    constructor(e, t, i, r, s, o, a) {
        super(e, i, false, r, s, o, a);
        this.message = t;
...
mSi = __decorate([__param(3, ln), __param(4, kc), __param(5, Fn), __param(6, wd)], mSi);
pSi = class extends hSi {
