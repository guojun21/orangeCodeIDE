...
mCa = class {
    ...
    getAriaLabel(e) {
        if (Gq(e)) {
            ...
            return this._getLabelWithInfo(e);
        } else {
            return "";
        }
    }
    _getLabelWithInfo(e) {
        ...
        switch (d) {
            case 0:
                i = t ? _(5175, null, s, u, a, e.response.toString(), t) : _(5176, null, u, e.response.toString());
                break;
            case 1:
                i = t ? _(5177, null, s, u, a, e.response.toString(), t) : _(5178, null, u, e.response.toString());
                break;
            default:
                i = t ? _(5179, null, s, u, a, d, e.response.toString(), t) : _(5180, null, u, d, e.response.toString());
                break;
        }
        return i;
    }
