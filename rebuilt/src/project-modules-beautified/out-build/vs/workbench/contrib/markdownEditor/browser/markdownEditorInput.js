...
ele = class extends XS {
  ...
  async save(e, t) {
    ...
    try {
      ...
      await this._fileService.writeFile(this._resource, Ms.fromString(this._currentContent));
      ...
      console.error("Error saving markdown file:", i);
      throw i;
    }
  }
  async revert(e, t) {
    try {
      ...
      console.error("Error reverting markdown file:", i);
      throw i;
    }
  }
  async resolve() {
...
ele = avn = __decorate([__param(1, Gr), __param(2, cB)], ele);
l$f = class extends at {
  constructor() {
    super();
  }
  canSerialize(n) {
  ...
  deserialize(n, e) {
    return n.invokeFunction(t => {
      try {
        if (!t.get(Tl).checkFeatureGate("wysiwyg_markdown")) {
          return;
        }
