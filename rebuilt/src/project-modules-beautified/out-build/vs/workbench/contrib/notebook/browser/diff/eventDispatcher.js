...
(function (n) {
  ...
  n[n.CellLayoutChanged = 2] = "CellLayoutChanged";
})(xEt ||= {});
p6f = class {
  constructor(n, e) {
    this.source = n;
    this.value = e;
    this.type = xEt.LayoutChanged;
  }
};
D_u = class extends at {
  constructor() {
    ...
    this._onDidChangeCellLayout = this._register(new Qe());
  ...
  emit(n) {
    for (let e = 0, t = n.length; e < t; e++) {
      const i = n[e];
      switch (i.type) {
        case xEt.LayoutChanged:
          this._onDidChangeLayout.fire(i);
          break;
        case xEt.CellLayoutChanged:
          this._onDidChangeCellLayout.fire(i);
          break;
      }
    }
  }
