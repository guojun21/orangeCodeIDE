...
uD();
D8f = 200;
xTa = class extends JV {
  constructor(e, t, i) {
    super();
    this._notebookEditor = e;
    this._executionOrderLabel = t;
    this._notebookExecutionStateService = i;
    this.kernelDisposables = this._register(new Ut());
  ...
  didRenderCell(e) {
    this.updateExecutionOrder(e.internalMetadata, true);
  }
  updateExecutionOrder(e, t = false) {
  ...
  updateState(e, t) {
    if (t.internalMetadataChanged) {
      this.updateExecutionOrder(e.internalMetadata);
    }
  }
    ...
    if (this.currentCell) {
      if (this.currentCell.isInputCollapsed) {
        ...
        if (this.currentCell instanceof jJ) {
          const i = this._notebookEditor.getAbsoluteTopOfElement(this.currentCell) + this.currentCell.layoutInfo.outputContainerOffset;
          const r = this._notebookEditor.scrollBottom;
          const s = 22;
          if (r <= i) {
            const o = i - r;
            e -= o;
            e = zA(e, s + 12, this.currentCell.layoutInfo.editorHeight - s + this.currentCell.layoutInfo.statusBarHeight);
          }
        }
