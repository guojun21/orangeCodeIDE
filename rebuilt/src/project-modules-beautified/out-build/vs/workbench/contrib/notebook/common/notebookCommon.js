...
si();
Gpi();
lCt = "workbench.editor.notebook";
Wpi = "workbench.editor.notebookTextDiffEditor";
dfg = "workbench.editor.notebookMultiTextDiffEditor";
Uun = "workbench.editor.interactive";
Wca = "workbench.editor.repl";
(function (n) {
  n[n.Markup = 1] = "Markup";
  n[n.Code = 2] = "Code";
})(zd ||= {});
kWl = ["application/json", "application/javascript", "text/html", "image/svg+xml", NA.latex, NA.markdown, "image/png", "image/jpeg", NA.text];
hfg = [NA.latex, NA.markdown, "application/json", "text/html", "image/svg+xml", "image/png", "image/jpeg", NA.text];
mfg = new Map([["ms-toolsai.jupyter", new Set(["jupyter-notebook", "interactive"])], ["ms-toolsai.jupyter-renderers", new Set(["jupyter-notebook", "interactive"])]]);
uCt = "_notAvailable";
(function (n) {
...
(function (n) {
  n[n.Unconfirmed = 1] = "Unconfirmed";
  n[n.Pending = 2] = "Pending";
  n[n.Executing = 3] = "Executing";
})(XE ||= {});
(function (n) {
  n[n.Unconfirmed = 1] = "Unconfirmed";
  n[n.Pending = 2] = "Pending";
...
(function (n) {
  n[n.WithHardKernelDependency = 0] = "WithHardKernelDependency";
  n[n.WithOptionalKernelDependency = 1] = "WithOptionalKernelDependency";
  n[n.Pure = 2] = "Pure";
  n[n.Never = 3] = "Never";
})(gfg ||= {});
(function (n) {
...
(function (n) {
  n[n.ModelChange = 1] = "ModelChange";
  n[n.Move = 2] = "Move";
  n[n.ChangeCellLanguage = 5] = "ChangeCellLanguage";
  n[n.Initialize = 6] = "Initialize";
  n[n.ChangeCellMetadata = 7] = "ChangeCellMetadata";
  n[n.Output = 8] = "Output";
  n[n.OutputItem = 9] = "OutputItem";
  n[n.ChangeCellContent = 10] = "ChangeCellContent";
  n[n.ChangeDocumentMetadata = 11] = "ChangeDocumentMetadata";
  n[n.ChangeCellInternalMetadata = 12] = "ChangeCellInternalMetadata";
  n[n.ChangeCellMime = 13] = "ChangeCellMime";
  n[n.Unknown = 100] = "Unknown";
})(sb ||= {});
(function (n) {
  n[n.Handle = 0] = "Handle";
  n[n.Index = 1] = "Index";
...
(function (n) {
  ...
  n[n.CellLanguage = 4] = "CellLanguage";
  n[n.DocumentMetadata = 5] = "DocumentMetadata";
  n[n.Move = 6] = "Move";
  n[n.OutputItems = 7] = "OutputItems";
  n[n.PartialMetadata = 8] = "PartialMetadata";
  n[n.PartialInternalMetadata = 9] = "PartialInternalMetadata";
})(bfg ||= {});
(function (n) {
...
(function (n) {
  ...
  function i(l, u) {
    return l.with({
      scheme: _n.vscodeNotebookCellOutput,
      query: new URLSearchParams({
        openIn: "editor",
        outputId: u ?? "",
        notebookScheme: l.scheme !== _n.file ? l.scheme : ""
      }).toString()
    });
  }
...
Qpi = n => Sc ? n.replace(/\//g, "\\") : n;
vfg = class {
  constructor(n = [], e = kWl) {
    this.defaultOrder = e;
    this.order = [...new Set(n)].map(t => ({
      pattern: t,
      matches: jae(Qpi(t))
    }));
  }
  sort(n) {
    ...
    if (e.size) {
      t = t.concat([...e.keys()].sort((i, r) => this.defaultOrder.indexOf(i) - this.defaultOrder.indexOf(r)));
    }
    return t;
  }
  prioritize(n, e) {
...
cNe = new Sn("notebookEditorCursorAtBoundary", "none");
Afg = new Sn("notebookEditorCursorAtLineBoundary", "none");
(function (n) {
  n.default = "default";
  n.option = "option";
})(jpi ||= {});
...
wfg = new TextDecoder();
zpi = "[A";
jca = zpi.split("").map(n => n.charCodeAt(0));
_fg = 10;
Cfg = 8;
Sfg = 13;
