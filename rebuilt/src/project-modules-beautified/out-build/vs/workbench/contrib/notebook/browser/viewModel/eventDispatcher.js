...
U8f = class extends at {
  ...
  emit(n) {
    for (let e = 0, t = n.length; e < t; e++) {
      const i = n[e];
      switch (i.type) {
        case dit.LayoutChanged:
          this._onDidChangeLayout.fire(i);
          break;
        case dit.MetadataChanged:
          this._onDidChangeMetadata.fire(i);
          break;
        case dit.CellStateChanged:
          this._onDidChangeCellState.fire(i);
          break;
      }
    }
  }
