...
Fkf = 5;
Ywi = 2;
IM = xi("composerUtilsService");
Okf = xi("composerPlanService");
hO = class extends at {
  ...
  async decideRunningComposerTabAction(e, t) {
    ...
    const p = await this._prettyDialogService.openDialog({
      title: "Replace current chat?",
      message: "You've reached the limit for open chats. To create a new one, you'll have to replace the current chat.",
      primaryButton: {
        id: "replace",
        label: "Replace Chat"
      },
  ...
  async getFileLinesContent(e) {
    ...
    try {
      ...
      return a.object.textEditorModel.getLinesContent();
    } catch (l) {
      console.error("[composer] error getting content of file", t, l);
      return null;
    } finally {
      a?.dispose();
    }
  ...
  async getFileContents(e) {
    ...
    try {
      a = await this.composerTextModelService.createModelReference(t, s, true);
      return a.object.textEditorModel.getValue();
    } catch (l) {
      console.error("[composer] error getting full content of file", t, l);
      return null;
    } finally {
      a?.dispose();
    }
...
\`\`\``;
  ...
  async *handleStreamComposer(e) {
    ...
    try {
      for await (const r of e.streamer) {
        ...
        if (r !== null && typeof r == "object" && "statusUpdates" in r && r.statusUpdates !== undefined && r.statusUpdates !== null && o) {
        ...
        if (r !== null && typeof r == "object" && "serviceStatusUpdate" in r && r.serviceStatusUpdate !== undefined && r.serviceStatusUpdate !== null && o && (this._composerDataService.updateComposerDataSetStore(e.composerHandle, l => l("conversationMap", o.bubbleId, "serviceStatusUpdate", {
        ...
        if (r !== null && typeof r == "object" && "starsFeedbackRequest" in r && r.starsFeedbackRequest !== undefined && r.starsFeedbackRequest !== null) {
        ...
        if (r !== null && typeof r == "object" && "stopUsingDsv3AgenticModel" in r && r.stopUsingDsv3AgenticModel === true) {
          i = true;
        }
        if (r !== null && typeof r == "object" && "imageDescription" in r && r.imageDescription !== undefined && r.imageDescription !== null && o) {
        ...
        if (r !== null && typeof r == "object" && "symbolLink" in r && r.symbolLink !== undefined && r.symbolLink !== null && o) {
        ...
        if (r !== null && typeof r == "object" && "fileLink" in r && r.fileLink !== undefined && r.fileLink !== null && o) {
          const l = r.fileLink;
  ...
  removeMessagesAfterBubble(e, t) {
    ...
    if (d.length > 0) {
      this._instantiationService.invokeFunction(f => f.get(Okf)).dereferencePlansCreatedByDeletedBubbles(e.composerId, d).catch(f => {
        ...
        for (const u of l) {
          if (u.onStartSubmitChatReturnShouldStop) {
            try {
              ...
              if (typeof d == "object" && d.shouldStop) {
                return d;
              }
            } catch (d) {
              ...
              if (Array.isArray(Se)) {
                for (const Ne of Se) {
                  ...
                  if (Ne && typeof Ne == "object") {
                    ...
                    const Ge = Oe.type;
                    const Le = Oe.data;
                    if (typeof Ge == "number" && Le !== undefined) {
                      ke.push({
                        type: Ge,
                        data: s(Le)
                      });
...
__decorate([Gs("ComposerUtilsService.decideRunningComposerTabAction")], hO.prototype, "decideRunningComposerTabAction", null);
__decorate([Gs("ComposerUtilsService.ensureCapabilitiesAreLoaded")], hO.prototype, "ensureCapabilitiesAreLoaded", null);
__decorate([Gs("ComposerUtilsService.getShouldWebSearchBeEnabled")], hO.prototype, "getShouldWebSearchBeEnabled", null);
__decorate([Gs("ComposerUtilsService.getShouldAutoSaveAgenticEdits")], hO.prototype, "getShouldAutoSaveAgenticEdits", null);
__decorate([Gs("ComposerUtilsService.replacedBubbleForFastEdit")], hO.prototype, "replacedBubbleForFastEdit", null);
__decorate([Gs("ComposerUtilsService.processConversationForFastEdit")], hO.prototype, "processConversationForFastEdit", null);
__decorate([Gs("ComposerUtilsService.handleStreamComposer")], hO.prototype, "handleStreamComposer", null);
__decorate([Gs("ComposerUtilsService.readFileContents")], hO.prototype, "readFileContents", null);
__decorate([Gs("ComposerUtilsService.getCodeBlockDataFromBubbleId")], hO.prototype, "getCodeBlockDataFromBubbleId", null);
__decorate([Gs("ComposerUtilsService.removeMessagesAfterBubble")], hO.prototype, "removeMessagesAfterBubble", null);
__decorate([Gs("ComposerUtilsService.runCapabilitiesForProcess")], hO.prototype, "runCapabilitiesForProcess", null);
__decorate([Gs("ComposerUtilsService.selectNextComposer")], hO.prototype, "selectNextComposer", null);
__decorate([Gs("ComposerUtilsService.selectPrevComposer")], hO.prototype, "selectPrevComposer", null);
__decorate([Gs("ComposerUtilsService.computeDiff")], hO.prototype, "computeDiff", null);
__decorate([Gs("ComposerUtilsService.computeDiffAndFormat")], hO.prototype, "computeDiffAndFormat", null);
__decorate([Gs("ComposerUtilsService.growChunk")], hO.prototype, "growChunk", null);
__decorate([Gs("ComposerUtilsService.shouldShowCancel")], hO.prototype, "shouldShowCancel", null);
__decorate([Gs("ComposerUtilsService.resumeFromToolFormerBubble")], hO.prototype, "resumeFromToolFormerBubble", null);
__decorate([Gs("ComposerUtilsService.getCurrentFile")], hO.prototype, "getCurrentFile", null);
__decorate([Gs("ComposerUtilsService.unformatComposerDiff")], hO.prototype, "unformatComposerDiff", null);
hO = __decorate([__param(0, Oa), __param(1, YZ), __param(2, Lr), __param(3, c_), __param(4, ku), __param(5, iie), __param(6, ln), __param(7, fr), __param(8, YD), __param(9, BA), __param(10, gnt), __param(11, rw), __param(12, _$e), __param(13, R1), __param(14, Ctt), __param(15, Ghn), __param(16, Hi), __param(17, EJ), __param(18, JF), __param(19, Jv), __param(20, DT), __param(21, Tl), __param(22, wg), __param(23, kmu), __param(24, uie)], hO);
Vi(IM, hO, 1);
