...
uB = class {
  ...
  get argvResource() {
    ...
    if (n) {
      return je.file(gS(n, "argv.json"));
    } else {
      return Wo(this.userHome, this.productService.dataFolderName, "argv.json");
    }
  }
  ...
  get builtinExtensionsPath() {
    ...
    if (n) {
      ...
      return k6(gS(og.asFileUri("").fsPath, "..", "extensions"));
    }
  }
  get extensionsDownloadLocation() {
    const n = this.args["extensions-download-dir"];
    if (n) {
      return je.file(dgt(n));
    } else {
      return je.file(gS(this.userDataPath, "CachedExtensionVSIXs"));
    }
  }
  get extensionsPath() {
    ...
    if (t) {
      return gS(t, "extensions");
    } else {
      return Wo(this.userHome, this.productService.dataFolderName, "extensions").fsPath;
    }
  }
  get extensionDevelopmentLocationURI() {
    const n = this.args.extensionDevelopmentPath;
    if (Array.isArray(n)) {
      return n.map(e => /^[^:/?#]+?:\/\//.test(e) ? je.parse(e) : je.file(k6(e)));
    }
  }
  ...
  get policyFile() {
    if (this.args["__enable-file-policy"] || xv) {
      const n = u2.VSCODE_PORTABLE;
      if (n) {
        return je.file(gS(n, "policy.json"));
      } else {
        return Wo(this.userHome, this.productService.dataFolderName, "policy.json");
      }
    }
  }
  get editSessionId() {
...
__decorate([cl], uB.prototype, "appRoot", null);
__decorate([cl], uB.prototype, "userHome", null);
__decorate([cl], uB.prototype, "userDataPath", null);
__decorate([cl], uB.prototype, "appSettingsHome", null);
__decorate([cl], uB.prototype, "tmpDir", null);
__decorate([cl], uB.prototype, "cacheHome", null);
__decorate([cl], uB.prototype, "stateResource", null);
__decorate([cl], uB.prototype, "userRoamingDataHome", null);
__decorate([cl], uB.prototype, "userDataSyncHome", null);
__decorate([cl], uB.prototype, "sync", null);
__decorate([cl], uB.prototype, "machineSettingsResource", null);
__decorate([cl], uB.prototype, "workspaceStorageHome", null);
__decorate([cl], uB.prototype, "localHistoryHome", null);
__decorate([cl], uB.prototype, "keyboardLayoutResource", null);
__decorate([cl], uB.prototype, "argvResource", null);
__decorate([cl], uB.prototype, "isExtensionDevelopment", null);
__decorate([cl], uB.prototype, "untitledWorkspacesHome", null);
__decorate([cl], uB.prototype, "builtinExtensionsPath", null);
__decorate([cl], uB.prototype, "extensionsPath", null);
__decorate([cl], uB.prototype, "extensionDevelopmentLocationURI", null);
__decorate([cl], uB.prototype, "extensionDevelopmentKind", null);
__decorate([cl], uB.prototype, "extensionTestsLocationURI", null);
__decorate([cl], uB.prototype, "debugExtensionHost", null);
__decorate([cl], uB.prototype, "logLevel", null);
__decorate([cl], uB.prototype, "extensionLogLevel", null);
__decorate([cl], uB.prototype, "serviceMachineIdResource", null);
__decorate([cl], uB.prototype, "disableTelemetry", null);
__decorate([cl], uB.prototype, "disableWorkspaceTrust", null);
__decorate([cl], uB.prototype, "useInMemorySecretStorage", null);
__decorate([cl], uB.prototype, "policyFile", null);
