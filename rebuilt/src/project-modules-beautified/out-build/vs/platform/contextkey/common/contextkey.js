...
v9.set("isWindows", Sc);
v9.set("isWeb", Eu);
v9.set("isMacNative", Fs && !Eu);
v9.set("isEdge", KMo);
v9.set("isFirefox", zMo);
v9.set("isChrome", cgt);
v9.set("isSafari", VMo);
I4t = new Map();
kah = Object.prototype.hasOwnProperty;
(function (n) {
  n[n.False = 0] = "False";
  n[n.True = 1] = "True";
  n[n.Defined = 2] = "Defined";
  n[n.Not = 3] = "Not";
  n[n.Equals = 4] = "Equals";
  n[n.NotEquals = 5] = "NotEquals";
  n[n.And = 6] = "And";
  n[n.Regex = 7] = "Regex";
  n[n.NotRegex = 8] = "NotRegex";
  n[n.Or = 9] = "Or";
  n[n.In = 10] = "In";
  n[n.NotIn = 11] = "NotIn";
  n[n.Greater = 12] = "Greater";
  n[n.GreaterEquals = 13] = "GreaterEquals";
  n[n.Smaller = 14] = "Smaller";
  n[n.SmallerEquals = 15] = "SmallerEquals";
  n[n.Function = 16] = "Function";
})(Eah ||= {});
xah = {
...
Nah = class rNi {
  ...
  parse(e) {
    ...
    this._tokens = this._scanner.reset(e).scan();
    this._current = 0;
    this._parsingErrors = [];
    try {
      const t = this._expr();
      if (!this._isAtEnd()) {
        const i = this._peek();
        const r = i.type === 17 ? Rah : undefined;
        this._parsingErrors.push({
          message: Bah,
          offset: i.offset,
          lexeme: T4t.getLexeme(i),
          additionalInfo: r
        });
        throw rNi._parseError;
      }
      return t;
    } catch (t) {
      if (t !== rNi._parseError) {
        throw t;
      }
      return;
    }
      ...
      case 17:
        {
          if (e.lexeme.startsWith("@")) {
            ...
            if (r.startsWith("!")) {
              ...
              const a = wah(o);
              if (a) {
                return xFo.createWithoutRegistration(r, () => !a());
              }
            }
            const s = wah(r) || (() => false);
          ...
          if (this._matchOne(9)) {
            ...
            if (!this._config.regexParsingWithErrorRecovery) {
              ...
              const a = o === s.length - 1 ? undefined : this._removeFlagsGY(s.substring(o + 1));
              let l;
              try {
              ...
              case 19:
                {
                  ...
                  for (let p = 0; p < r.lexeme.length; p++) {
                    if (r.lexeme.charCodeAt(p) === 40) {
                      a++;
                    } else if (r.lexeme.charCodeAt(p) === 41) {
                      a--;
                    }
                  }
                  while (!this._isAtEnd() && o.type !== 15 && o.type !== 16) {
                    switch (o.type) {
                      case 0:
                        a++;
                        break;
                    ...
                    s.push(T4t.getLexeme(o));
                    this._advance();
                    o = this._peek();
                  }
                  const l = s.join("");
                  const u = l.lastIndexOf("/");
                  const d = u === l.length - 1 ? undefined : this._removeFlagsGY(l.substring(u + 1));
                  let m;
                  try {
          ...
          switch (this._peek().type) {
            ...
            case 5:
              this._advance();
              return DFo.create(t, this._value());
            case 6:
              this._advance();
              return BFo.create(t, this._value());
            case 7:
              this._advance();
              return R4t.create(t, this._value());
            case 8:
              this._advance();
              return IFo.create(t, this._value());
            case 13:
              this._advance();
              return Ee.in(t, this._value());
            default:
              return Ee.has(t);
          }
        }
  ...
  _errExpectedButGot(e, t, i) {
    const r = _(1826, null, e, T4t.getLexeme(t));
    const s = t.offset;
    const o = T4t.getLexeme(t);
    this._parsingErrors.push({
      message: r,
      offset: s,
      lexeme: o,
...
Ee = class {
  ...
  static and(...n) {
    return _kc.create(n, null, true);
  }
  static or(...n) {
    return PFo.create(n, null, true);
  }
  static greater(n, e) {
...
D4t = class mJb {
  ...
  negate() {
    this.negated ||= B4t.create(this.key, this);
    return this.negated;
  }
};
Kgt = class pJb {
  static create(e, t, i = null) {
    if (typeof t == "boolean") {
      if (t) {
        return D4t.create(e, i);
      } else {
        return B4t.create(e, i);
      }
    }
    const r = v9.get(e);
    if (typeof r == "boolean") {
  ...
  cmp(e) {
    if (e.type !== this.type) {
      ...
      return Vgt(this.key, this.value, e.key, e.value);
    }
  }
  equals(e) {
    if (e.type === this.type) {
  ...
  negate() {
    this.negated ||= TFo.create(this.key, this.value, this);
    return this.negated;
  }
};
ykc = class gJb {
  ...
  cmp(e) {
    if (e.type !== this.type) {
      ...
      return Vgt(this.key, this.valueKey, e.key, e.valueKey);
    }
  }
  equals(e) {
    if (e.type === this.type) {
      return this.key === e.key && this.valueKey === e.valueKey;
    } else {
      return false;
    }
  }
  ...
  evaluate(e) {
    ...
    if (Array.isArray(t)) {
      return t.includes(i);
    } else if (typeof i == "string" && typeof t == "object" && t !== null) {
      return kah.call(t, i);
    } else {
      return false;
    }
  ...
  negate() {
    this.negated ||= wkc.create(this.key, this.valueKey);
    return this.negated;
  }
};
wkc = class fJb {
  ...
  constructor(e, t) {
    ...
    this.valueKey = t;
    this.type = 11;
    this._negated = ykc.create(e, t);
  }
  cmp(e) {
    if (e.type !== this.type) {
      return this.type - e.type;
    } else {
      return this._negated.cmp(e._negated);
    }
  }
  equals(e) {
    if (e.type === this.type) {
      return this._negated.equals(e._negated);
    } else {
      return false;
    }
  }
...
TFo = class bJb {
  ...
  negate() {
    this.negated ||= Kgt.create(this.key, this.value, this);
    return this.negated;
  }
};
B4t = class vJb {
  ...
  negate() {
    this.negated ||= D4t.create(this.key, this);
    return this.negated;
  }
};
R4t = class AJb {
  ...
  evaluate(e) {
    if (typeof this.value == "string") {
      ...
      return parseFloat(e.getValue(this.key)) > this.value;
    }
  }
  serialize() {
    return `${this.key} > ${this.value}`;
  ...
  negate() {
    this.negated ||= BFo.create(this.key, this.value, this);
    return this.negated;
  }
};
IFo = class yJb {
  ...
  negate() {
    this.negated ||= DFo.create(this.key, this.value, this);
    return this.negated;
  }
};
DFo = class wJb {
  ...
  negate() {
    this.negated ||= IFo.create(this.key, this.value, this);
    return this.negated;
  }
};
BFo = class _Jb {
  ...
  negate() {
    this.negated ||= R4t.create(this.key, this.value, this);
    return this.negated;
  }
};
RFo = class CJb {
  ...
  cmp(e) {
    ...
    const i = e.regexp ? e.regexp.source : "";
    if (t < i) {
      return -1;
    } else if (t > i) {
      return 1;
...
Mah = class oad {
  ...
  equals(e) {
    if (e.type === this.type) {
      return this._actual.equals(e._actual);
    } else {
      return false;
    }
  }
...
_kc = class BCn {
  ...
  substituteConstants() {
    ...
    if (e === this.expr) {
      ...
      return BCn.create(e, this.negated, false);
    }
  }
  evaluate(e) {
    for (let t = 0, i = this.expr.length; t < i; t++) {
  ...
  static _normalizeArr(e, t, i) {
    ...
    if (r.length !== 0) {
      ...
      while (r.length > 1) {
        ...
        const a = r.pop();
        const l = r.length === 0;
        const u = PFo.create(o.expr.map(d => BCn.create([d, a], null, i)), null, l);
        if (u) {
          r.push(u);
          r.sort(r4n);
        }
  ...
  negate() {
    if (!this.negated) {
      ...
      this.negated = PFo.create(e, this, true);
    }
    return this.negated;
  }
};
PFo = class LDt {
  ...
  substituteConstants() {
    ...
    if (e === this.expr) {
      ...
      return LDt.create(e, this.negated, false);
    }
  }
  evaluate(e) {
    for (let t = 0, i = this.expr.length; t < i; t++) {
  ...
  negate() {
    if (!this.negated) {
      ...
      while (e.length > 1) {
        ...
        const i = e.shift();
        const r = [];
        for (const s of Sah(t)) {
          for (const o of Sah(i)) {
            r.push(_kc.create([s, o], null, false));
          }
        }
        e.unshift(LDt.create(r, null, false));
      }
      this.negated = LDt.create(e, this, true);
    }
    return this.negated;
  }
};
  ...
  constructor(e, t, i) {
    ...
    if (typeof i == "object") {
      ...
      JGa._info.push({
        key: e,
        description: i,
        type: t != null ? typeof t : undefined
      });
    }
  }
  bindTo(e) {
