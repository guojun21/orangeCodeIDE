...
Er();
Ht();
X5o = xi("IEditorCancelService");
xBc = new Sn("cancellableOperation", false, _(1077, null));
Vi(X5o, class {
  constructor() {
  ...
  add(n, e) {
    ...
    if (!t) {
      t = n.invokeWithinContext(r => {
        const s = xBc.bindTo(r.get(wi));
        const o = new WD();
        return {
          key: s,
          tokens: o
...
$Sh = class extends Wc {
  constructor(n, e) {
    super(e);
    this.editor = n;
    this._unregister = n.invokeWithinContext(t => t.get(X5o).add(n, this));
  }
  dispose() {
    this._unregister();
    super.dispose();
