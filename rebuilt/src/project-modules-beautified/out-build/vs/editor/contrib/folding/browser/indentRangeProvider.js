...
fgi = class {
  constructor(n, e, t) {
    ...
    this.foldingRangesLimit = t;
    this.id = Xvg;
  }
  dispose() {}
  compute(n) {
    const e = this.languageConfigurationService.getLanguageConfiguration(this.editorModel.getLanguageId()).foldingRules;
    const t = e && !!e.offSide;
    const i = e && e.markers;
...
eAg = class {
  ...
  insertFirst(n, e, t) {
    ...
    this._startIndexes[i] = n;
    this._endIndexes[i] = e;
    this._length++;
    if (t < 1000) {
      this._indentOccurrences[t] = (this._indentOccurrences[t] || 0) + 1;
    }
  }
  toIndentRanges(n) {
    ...
    if (this._length <= e) {
      ...
      const i = new Uint32Array(this._length);
      for (let r = this._length - 1, s = 0; r >= 0; r--, s++) {
        t[s] = this._startIndexes[r];
        i[s] = this._endIndexes[r];
      }
      return new Qae(t, i);
    } else {
      this._foldingRangesLimit.update(this._length, e);
      let t = 0;
      let i = this._indentOccurrences.length;
      ...
      const r = n.getOptions().tabSize;
      const s = new Uint32Array(e);
      const o = new Uint32Array(e);
      for (let a = this._length - 1, l = 0; a >= 0; a--) {
        const u = this._startIndexes[a];
        const d = n.getLineContent(u);
        const m = mOo(d, r);
        if (m < i || m === i && t++ < e) {
          s[l] = u;
          o[l] = this._endIndexes[a];
          l++;
        }
      }
      return new Qae(s, o);
