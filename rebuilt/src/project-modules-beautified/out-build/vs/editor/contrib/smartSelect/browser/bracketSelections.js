...
cjl = class jFe {
  async provideSelectionRanges(e, t) {
    ...
    for (const r of t) {
      ...
      i.push(s);
      const o = new Map();
      await new Promise(a => jFe._bracketsRightYield(a, 0, e, r, o));
      await new Promise(a => jFe._bracketsLeftYield(a, 0, e, r, o, s));
    }
    return i;
  }
  static {
  ...
  static _bracketsRightYield(e, t, i, r, s) {
    ...
    while (true) {
      ...
      if (l.bracketInfo.isOpeningBracket) {
        const d = l.bracketInfo.bracketText;
        const m = o.has(d) ? o.get(d) : 0;
        o.set(d, m + 1);
      } else {
        const d = l.bracketInfo.getOpeningBrackets()[0].bracketText;
        let m = o.has(d) ? o.get(d) : 0;
        m -= 1;
        o.set(d, Math.max(0, m));
        if (m < 0) {
          let p = s.get(d);
          if (!p) {
            p = new WD();
      ...
      if (u.bracketInfo.isOpeningBracket) {
        ...
        if (p < 0) {
          ...
          if (g) {
            ...
            const A = Zt.fromPositions(u.range.getEndPosition(), f.getStartPosition());
            const w = Zt.fromPositions(u.range.getStartPosition(), f.getEndPosition());
            o.push({
              range: A
            });
            o.push({
        ...
        const m = u.bracketInfo.getOpeningBrackets()[0].bracketText;
        const p = a.has(m) ? a.get(m) : 0;
        a.set(m, p + 1);
      }
  ...
  static _addBracketLeading(e, t, i) {
    ...
    const s = e.getLineFirstNonWhitespaceColumn(r);
    if (s !== 0 && s !== t.startColumn) {
      i.push({
    ...
    if (o > 0) {
      ...
      if (a === t.startColumn && a !== e.getLineLastNonWhitespaceColumn(o)) {
        i.push({
