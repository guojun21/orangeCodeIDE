...
zmg = class extends at {
  constructor(n) {
    ...
    e.classList.add("close-button-inner-div");
    Rt(this._button, e);
    Rt(e, jmg(".button" + Qt.asCSSSelector(us("color-picker-close", Be.close, _(1023, null))))).classList.add("close-icon");
