...
Cgi = MAg = class extends at {
  ...
  constructor(e, t, i) {
    ...
    this._contextKeyValue = oSA(this._contextKey, this._contextKeyService).recomputeInitiallyAndOnChange(this._store);
    this.isEnabled = this._contextKeyValue.map(r => r !== undefined);
  }
  log(e) {
    const t = this._contextKeyValue.get();
    if (t) {
      this._commandService.executeCommand(t, e);
      return true;
    } else {
      return false;
    }
