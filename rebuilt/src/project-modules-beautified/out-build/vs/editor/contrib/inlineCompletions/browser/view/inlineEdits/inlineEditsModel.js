...
_jl = class {
  constructor(n, e, t) {
    ...
    this.displayName = this.inlineEdit.inlineCompletion.source.provider.displayName ?? _(1366, null);
...
Yyg = class {
  constructor(n, e, t, i) {
    this.lineRange = t;
    const r = HB(n);
    const s = Ro(this, o => r.isFocused.read(o) && e.inlineCompletionState.read(o)?.inlineCompletion?.sourceInlineCompletion.showInlineEditMenu ? sV.Accept : sV.Inactive);
