...
DMe = class extends at {
  ...
  constructor(e, t, i, r, s) {
    ...
    this.debounceInformation = s.for(this.providers, "Links", {
      min: 1000,
      max: 4000
    });
    this.computeLinks = this._register(new Hu(() => this.computeLinksNow(), 1000));
  ...
  async computeLinksNow() {
    if (!this.editor.hasModel() || !this.editor.getOption(72)) {
      return;
    }
    ...
    if (!e.isTooLargeForSyncing() && this.providers.has(e)) {
      ...
      this.computePromise = dw(t => Nxf(this.providers, e, t));
      try {
        const t = new J_(false);
        this.activeLinksList = await this.computePromise;
        this.debounceInformation.update(e, t.elapsed());
        if (e.isDisposed()) {
          return;
        }
  ...
  updateDecorations(e) {
    const t = this.editor.getOption(79) === "altKey";
    const i = [];
    const r = Object.keys(this.currentOccurrences);
    for (const o of r) {
    ...
    if (this.isEnabled(e, t)) {
      ...
      if (r) {
        this.editor.changeDecorations(s => {
          r.activate(s, i);
          this.activeLinkDecorationId = r.decorationId;
        });
      }
    } else {
      this.cleanUpActiveLinkDecoration();
  ...
  onEditorMouseUp(e) {
    ...
    if (t) {
      this.openLinkOccurrence(t, e.hasSideBySideModifier, true);
    }
  }
  openLinkOccurrence(e, t, i = false) {
    ...
    r.resolve(Cs.None).then(s => {
      ...
      if (o === "invalid") {
        this.notificationService.warn(_(1425, null, r.url.toString()));
      } else if (o === "missing") {
        this.notificationService.warn(_(1426, null));
      } else {
        Gc(s);
      }
    });
...
DMe = Opu = __decorate([__param(1, Ja), __param(2, ms), __param(3, $u), __param(4, ene)], DMe);
Upu = {
  general: Zh.register({
...
$pu = class TWa {
  static decoration(e, t) {
    return {
      range: e.range,
      options: TWa._getOptions(e, t, false)
    };
  }
  ...
  activate(e, t) {
    e.changeDecorationOptions(this.decorationId, TWa._getOptions(this.link, t, true));
  }
  deactivate(e, t) {
    e.changeDecorationOptions(this.decorationId, TWa._getOptions(this.link, t, false));
  }
};
