...
Ngi = class {
  ...
  static {
    this.AtEnd = new Sn("atEndOfWord", false, {
      type: "boolean",
      description: _(1634, null)
    });
  }
  constructor(e, t) {
    this._editor = e;
    this._enabled = false;
    this._ckAtEnd = ajl.AtEnd.bindTo(t);
    this._configListener = this._editor.onDidChangeConfiguration(i => i.hasChanged(128) && this._update());
    this._update();
  }
  dispose() {
    ...
    if (this._enabled !== e) {
      ...
      if (this._enabled) {
        const t = () => {
          ...
          const s = i.getWordAtPosition(r.getStartPosition());
          if (!s) {
            this._ckAtEnd.set(false);
            return;
          }
        ...
        this._selectionListener = this._editor.onDidChangeCursorSelection(t);
        t();
