...
i$e = class extends at {
  ...
  constructor(e, t, i, r, s, o) {
    super();
    this._semanticTokensStylingService = t;
    this._themeService = i;
    this._configurationService = r;
    this._editor = e;
    this._provider = o.documentRangeSemanticTokensProvider;
    this._debounceInformation = s.for(this._provider, "DocumentRangeSemanticTokens", {
      min: 100,
      max: 500
    });
    this._tokenizeViewport = this._register(new Hu(() => this._tokenizeViewportNow(), 100));
  ...
  _tokenizeViewportNow() {
    ...
    if (!yua(e, this._themeService, this._configurationService)) {
      if (e.tokenization.hasSomeSemanticTokens()) {
        e.tokenization.setSemanticTokens(null, false);
      }
      return;
    }
  ...
  _requestRange(e, t) {
    ...
    const r = dw(o => Promise.resolve(Ojl(this._provider, e, t, o)));
    const s = new J_(false);
    r.then(o => {
      this._debounceInformation.update(e, s.elapsed());
      if (!o || !o.tokens || e.isDisposed() || e.getVersionId() !== i) {
        return;
      }
      const {
        provider: a,
      ...
      const u = this._semanticTokensStylingService.getStyling(a);
      e.tokenization.setPartialSemanticTokens(t, Gwg(l, u, e.getLanguageId()));
    }).then(() => this._removeOutstandingRequest(r), () => this._removeOutstandingRequest(r));
    return r;
  }
};
i$e = Jjl = __decorate([__param(1, zgi), __param(2, bo), __param(3, Fn), __param(4, ene), __param(5, $u)], i$e);
Mg(i$e.ID, i$e, 1);
