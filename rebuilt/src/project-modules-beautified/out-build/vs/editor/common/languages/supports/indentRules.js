...
// Size: 1315 bytes
(function(n) {
    n[n.INCREASE_MASK = 1] = "INCREASE_MASK";
    n[n.DECREASE_MASK = 2] = "DECREASE_MASK";
    n[n.INDENT_NEXTLINE_MASK = 4] = "INDENT_NEXTLINE_MASK";
    n[n.UNINDENT_MASK = 8] = "UNINDENT_MASK";
})(Och ||= {});
Uch = class {
    constructor(n) {
    ...
    getIndentMetadata(n) {
        let e = 0;
        if (this.shouldIncrease(n)) {
            e += 1;
        }
        if (this.shouldDecrease(n)) {
            e += 2;
        }
        if (this.shouldIndentNextLine(n)) {
            e += 4;
        }
