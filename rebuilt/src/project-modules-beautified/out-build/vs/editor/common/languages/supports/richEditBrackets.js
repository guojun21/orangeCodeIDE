...
Nch = class dad {
  constructor(e, t, i, r, s, o) {
    ...
    this.close = r;
    this.forwardRegex = s;
    this.reversedRegex = o;
    this._openSet = dad._toSet(this.open);
    this._closeSet = dad._toSet(this.close);
  }
  isOpen(e) {
...
Mch = class {
  constructor(n, e) {
    ...
    const t = lrA(e);
    this.brackets = t.map((i, r) => new Nch(n, r, i.open, i.close, urA(i.open, i.close, t, r), drA(i.open, i.close, t, r)));
    this.forwardRegex = hrA(this.brackets);
    this.reversedRegex = mrA(this.brackets);
    this.textIsBracket = {};
    this.textIsOpenBracket = {};
    this.maxBracketLength = 0;
    for (const i of this.brackets) {
      for (const r of i.open) {
        this.textIsBracket[r] = i;
        this.textIsOpenBracket[r] = true;
        this.maxBracketLength = Math.max(this.maxBracketLength, r.length);
      }
      for (const r of i.close) {
        this.textIsBracket[r] = i;
        this.textIsOpenBracket[r] = false;
        this.maxBracketLength = Math.max(this.maxBracketLength, r.length);
      }
    }
  }
