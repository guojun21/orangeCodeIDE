...
(function (n) {
  n[n.Increase = 0] = "Increase";
  n[n.Decrease = 1] = "Decrease";
})(b3 ||= {});
(function (n) {
  n[n.Method = 0] = "Method";
...
(function (n) {
  const e = new Map();
  e.set(0, Be.symbolMethod);
  e.set(1, Be.symbolFunction);
  e.set(2, Be.symbolConstructor);
  e.set(3, Be.symbolField);
  e.set(4, Be.symbolVariable);
  e.set(5, Be.symbolClass);
  e.set(6, Be.symbolStruct);
  e.set(7, Be.symbolInterface);
  e.set(8, Be.symbolModule);
  e.set(9, Be.symbolProperty);
  e.set(10, Be.symbolEvent);
  e.set(11, Be.symbolOperator);
  e.set(12, Be.symbolUnit);
  e.set(13, Be.symbolValue);
  e.set(15, Be.symbolEnum);
  e.set(14, Be.symbolConstant);
  e.set(15, Be.symbolEnum);
  e.set(16, Be.symbolEnumMember);
  e.set(17, Be.symbolKeyword);
  e.set(27, Be.symbolSnippet);
  e.set(18, Be.symbolText);
  e.set(19, Be.symbolColor);
  e.set(20, Be.symbolFile);
  e.set(21, Be.symbolReference);
  e.set(22, Be.symbolCustomColor);
  e.set(23, Be.symbolFolder);
  e.set(24, Be.symbolTypeParameter);
  e.set(25, Be.account);
  e.set(26, Be.issues);
  function t(o) {
    let a = e.get(o);
...
xgh = class {
  constructor(n, e, t, i) {
    this.range = n;
    this.text = e;
    this.completionKind = t;
    this.isSnippetText = i;
  }
  equals(n) {
...
(function (n) {
  ...
  e.set(1, Be.symbolModule);
  e.set(2, Be.symbolNamespace);
  e.set(3, Be.symbolPackage);
  e.set(4, Be.symbolClass);
  e.set(5, Be.symbolMethod);
  e.set(6, Be.symbolProperty);
  e.set(7, Be.symbolField);
  e.set(8, Be.symbolConstructor);
  e.set(9, Be.symbolEnum);
  e.set(10, Be.symbolInterface);
  e.set(11, Be.symbolFunction);
  e.set(12, Be.symbolVariable);
  e.set(13, Be.symbolConstant);
  e.set(14, Be.symbolString);
  e.set(15, Be.symbolNumber);
  e.set(16, Be.symbolBoolean);
  e.set(17, Be.symbolArray);
  e.set(18, Be.symbolObject);
  e.set(19, Be.symbolKey);
  e.set(20, Be.symbolNull);
  e.set(21, Be.symbolEnumMember);
  e.set(22, Be.symbolStruct);
  e.set(23, Be.symbolEvent);
  e.set(24, Be.symbolOperator);
  e.set(25, Be.symbolTypeParameter);
  function t(s) {
    let o = e.get(s);
    if (!o) {
...
(function (n) {
  n[n.Current = 0] = "Current";
  n[n.Outdated = 1] = "Outdated";
})(yOo ||= {});
(function (n) {
  n[n.Editing = 0] = "Editing";
  n[n.Preview = 1] = "Preview";
})(NOt ||= {});
(function (n) {
  n[n.Published = 0] = "Published";
  n[n.Draft = 1] = "Draft";
})(Bgh ||= {});
(function (n) {
  n[n.Type = 1] = "Type";
...
rxc = class {
  constructor(n) {
    this.createSupport = n;
    this._tokenizationSupport = null;
  }
  dispose() {
    if (this._tokenizationSupport) {
      this._tokenizationSupport.then(n => {
        if (n) {
          n.dispose();
        }
      });
...
(function (n) {
  n[n.None = 0] = "None";
  n[n.Option = 1] = "Option";
  n[n.Default = 2] = "Default";
  n[n.Preferred = 3] = "Preferred";
})(xft ||= {});
(function (n) {
  n[n.Invoke = 0] = "Invoke";
  n[n.Automatic = 1] = "Automatic";
