...
WSe = class Oad {
  static trivial(e, t) {
    return new Oad([new H4(dm.ofLength(e.length), dm.ofLength(t.length))], false);
  }
  static trivialTimedOut(e, t) {
    return new Oad([new H4(dm.ofLength(e.length), dm.ofLength(t.length))], true);
  }
  constructor(e, t) {
    this.diffs = e;
    this.hitTimeout = t;
...
H4 = class AJe {
  ...
  static assertSorted(e) {
    ...
    for (const i of e) {
      if (t && (!(t.seq1Range.endExclusive <= i.seq1Range.start) || !(t.seq2Range.endExclusive <= i.seq2Range.start))) {
        throw new _m("Sequence diffs must be sorted");
      }
      t = i;
    }
  }
  ...
  delta(e) {
    if (e === 0) {
      ...
      return new AJe(this.seq1Range.delta(e), this.seq2Range.delta(e));
    }
  }
  deltaStart(e) {
    if (e === 0) {
      ...
      return new AJe(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e));
    }
  }
  deltaEnd(e) {
    if (e === 0) {
      ...
      return new AJe(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e));
    }
  }
  ...
  intersect(e) {
    ...
    const i = this.seq2Range.intersect(e.seq2Range);
    if (!!t && !!i) {
      return new AJe(t, i);
    }
  }
...
uKe = class nWa {
  ...
  delta(e) {
    if (e === 0) {
      ...
      return new nWa(this.offset1 + e, this.offset2 + e);
    }
  }
  equals(e) {
...
Z0h = class {
  constructor(n, e) {
    this.timeout = n;
    this.shouldGracefullyFallBackOnTimeout = e;
    this.startTime = Date.now();
    this.numChecks = 0;
    this.valid = true;
    if (n <= 0) {
      throw new _m("timeout must be positive");
    }
    this.expireTime = this.startTime + n;
  }
  isValid() {
    this.numChecks++;
    if (this.valid === false || this.numChecks % 25 != 0) {
      return this.valid;
    } else {
      if (!(Date.now() < this.expireTime) && this.valid) {
        this.valid = false;
      }
      return this.valid;
    }
