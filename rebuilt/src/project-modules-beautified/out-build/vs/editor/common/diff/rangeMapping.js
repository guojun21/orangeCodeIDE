...
Wde = class $Cn {
  static inverse(e, t, i) {
    ...
    for (const l of e) {
      ...
      if (!u.modified.isEmpty) {
        r.push(u);
      }
      s = l.original.endLineNumberExclusive;
      o = l.modified.endLineNumberExclusive;
    }
  ...
  static clip(e, t, i) {
    const r = [];
    for (const s of e) {
      const o = s.original.intersect(t);
      const a = s.modified.intersect(i);
      if (o && !o.isEmpty && a && !a.isEmpty) {
        r.push(new $Cn(o, a));
      }
    }
    return r;
  ...
  toRangeMapping() {
    ...
    const t = this.modified.toInclusiveRange();
    if (e && t) {
      return new zH(e, t);
    }
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      if (this.modified.startLineNumber !== 1 || this.original.startLineNumber !== 1) {
        throw new _m("not a valid diff");
      }
      ...
      return new zH(new Zt(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new Zt(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
    }
  }
  toRangeMapping2(e, t) {
    if (R0h(this.original.endLineNumberExclusive, e) && R0h(this.modified.endLineNumberExclusive, t)) {
      return new zH(new Zt(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new Zt(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    }
    if (!this.original.isEmpty && !this.modified.isEmpty) {
      return new zH(Zt.fromPositions(new ar(this.original.startLineNumber, 1), x3t(new ar(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), Zt.fromPositions(new ar(this.modified.startLineNumber, 1), x3t(new ar(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
    }
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) {
      return new zH(Zt.fromPositions(x3t(new ar(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), x3t(new ar(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), Zt.fromPositions(x3t(new ar(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), x3t(new ar(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
    }
    throw new _m();
  }
};
_3 = class tWa extends Wde {
  static fromRangeMappings(e) {
    const t = rh.join(e.map(r => rh.fromRangeInclusive(r.originalRange)));
    const i = rh.join(e.map(r => rh.fromRangeInclusive(r.modifiedRange)));
...
zH = class qCn {
  ...
  static fromEditJoin(e) {
    const t = e.getNewRanges();
    const i = e.edits.map((r, s) => new qCn(r.range, t[s]));
    return qCn.join(i);
  }
  static join(e) {
    if (e.length === 0) {
      throw new _m("Cannot join an empty list of range mappings");
    }
    let t = e[0];
  ...
  static assertSorted(e) {
    for (let t = 1; t < e.length; t++) {
      ...
      if (!i.originalRange.getEndPosition().isBeforeOrEqual(r.originalRange.getStartPosition()) || !i.modifiedRange.getEndPosition().isBeforeOrEqual(r.modifiedRange.getStartPosition())) {
        throw new _m("Range mappings must be sorted");
      }
    }
  }
  constructor(e, t) {
    this.originalRange = e;
    this.modifiedRange = t;
  }
  toString() {
