...
VOo = class {
  constructor(n, e, t, i, r, s, o) {
    ...
    this.content = n;
    this.continuesWithWrappedLine = e;
    this.minColumn = t;
    this.maxColumn = i;
    this.startVisibleColumn = r;
    this.tokens = s;
    this.inlineDecorations = o;
  }
};
zOt = class Sad {
  constructor(e, t, i, r, s, o, a, l, u, d) {
    ...
    this.maxColumn = t;
    this.content = i;
    this.continuesWithWrappedLine = r;
    this.isBasicASCII = Sad.isBasicASCII(i, o);
    this.containsRTL = Sad.containsRTL(i, this.isBasicASCII, s);
    this.tokens = a;
...
(function (n) {
  ...
  n[n.Before = 1] = "Before";
  n[n.After = 2] = "After";
  n[n.RegularAffectingLetterSpacing = 3] = "RegularAffectingLetterSpacing";
})(xbh ||= {});
Ode = class {
  constructor(n, e, t) {
    this.range = n;
    this.inlineClassName = e;
    this.type = t;
  }
};
Tbh = class {
  constructor(n, e, t, i) {
    this.startOffset = n;
    this.endOffset = e;
    this.inlineClassName = t;
    this.inlineClassNameAffectsLetterSpacing = i;
  }
