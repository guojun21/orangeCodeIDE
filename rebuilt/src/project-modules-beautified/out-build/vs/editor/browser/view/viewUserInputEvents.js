...
MTc = class AGb {
  ...
  static convertViewToModelMouseTarget(e, t) {
    ...
    i.position &&= t.convertViewPositionToModelPosition(i.position);
    i.range &&= t.convertViewRangeToModelRange(i.range);
    if (i.type === 5 || i.type === 8) {
      i.detail = this.convertViewToModelViewZoneData(i.detail, t);
    }
    return i;
  }
  static convertViewToModelViewZoneData(e, t) {
    return {
      ...
      afterLineNumber: t.convertViewPositionToModelPosition(new ar(e.afterLineNumber, 1)).lineNumber
    };
  }
};
