...
q3 = class extends WS {
  constructor(e, t, i, r, s, o, a, l, u, d, m, p, g, f) {
    super(e, {
      ...r.getRawOptions(),
      overflowWidgetsDomNode: r.getOverflowWidgetsDomNode()
    }, i, s, o, a, l, u, d, m, p, g, f);
    this._parentEditor = r;
    this._overwriteOptions = t;
    super.updateOptions(this._overwriteOptions);
    this._register(r.onDidChangeConfiguration(A => this._onParentConfigurationChanged(A)));
  }
  getParentEditor() {
  ...
  updateOptions(e) {
    f3(this._overwriteOptions, e, true);
    super.updateOptions(this._overwriteOptions);
  }
};
