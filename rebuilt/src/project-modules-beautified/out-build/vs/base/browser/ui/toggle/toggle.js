...
kpg = class extends w3 {
  constructor(n, e, t) {
    super(n, e, t);
    this.toggle = this._register(new H3({
      actionClassName: this._action.class,
      isChecked: !!this._action.checked,
      title: this.options.keybinding ? `${this._action.label} (${this.options.keybinding})` : this._action.label,
      notFocusable: true,
      inputActiveOptionBackground: t.toggleStyles?.inputActiveOptionBackground,
      inputActiveOptionBorder: t.toggleStyles?.inputActiveOptionBorder,
      inputActiveOptionForeground: t.toggleStyles?.inputActiveOptionForeground,
...
H3 = class extends HR {
  constructor(n) {
    ...
    if (this._opts.icon) {
      ...
      e.push(...Qt.asClassNameArray(this._icon));
    }
    if (this._opts.actionClassName) {
      e.push(...this._opts.actionClassName.split(" "));
    }
    if (this._checked) {
      e.push("checked");
    }
    this.domNode = document.createElement("div");
    this._hover = this._register(q4().setupManagedHover(n.hoverDelegate ?? Sm("mouse"), this.domNode, this._opts.title));
    this.domNode.classList.add(...e);
  ...
  setIcon(n) {
    if (this._icon) {
      this.domNode.classList.remove(...Qt.asClassNameArray(this._icon));
    }
    this._icon = n;
    if (this._icon) {
      this.domNode.classList.add(...Qt.asClassNameArray(this._icon));
    }
  }
  width() {
    return 22;
  ...
  setTitle(n) {
    ...
    this.domNode.setAttribute("aria-label", n);
  }
  set visible(n) {
...
xun = class LWb extends HR {
  ...
  constructor(e, t, i) {
    ...
    this._onChange = this._register(new Qe());
    this.onChange = this._onChange.event;
    this.checkbox = this._register(new H3({
      title: this.title,
      isChecked: this.isChecked,
      icon: Be.check,
      actionClassName: LWb.CLASS_NAME,
      ...Eun
    }));
    this.domNode = this.checkbox.domNode;
    this.styles = i;
    this.applyStyles();
    this._register(this.checkbox.onChange(r => {
      this.applyStyles();
      this._onChange.fire(r);
    }));
  }
  get checked() {
...
Epg = class extends w3 {
  constructor(n, e, t) {
    super(n, e, t);
    this.toggle = this._register(new xun(this._action.label, !!this._action.checked, t.checkboxStyles));
  ...
  render(n) {
    ...
    if (this.options.label && this._action.label) {
      const e = this.element.appendChild(Ct("span.checkbox-label", undefined, this._action.label));
