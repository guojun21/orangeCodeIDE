...
// Module: out-build/vs/base/common/keyCodes.js
// Offset: 289565 (bundle byte offset)
// Size: 20857 bytes
(function(n) {
...
ZMo = class {
    ...
    define(n, e) {
        this._keyCodeToStr[n] = e;
        this._strToKeyCode[e.toLowerCase()] = n;
    }
    keyCodeToStr(n) {
        return this._keyCodeToStr[n];
    }
    strToKeyCode(n) {
        return this._strToKeyCode[n.toLowerCase()] || 0;
    }
};
X2n = new ZMo();
XMo = new ZMo();
...
t2o = {};
R0c = [];
P0c = Object.create(null);
L0c = Object.create(null);
Yj = {
    lowerCaseToEnum: n => L0c[n] || 0,
    toEnum: n => P0c[n] || 0,
    toString: n => R0c[n] || "None"
};
wY = [];
OFt = [];
for (let n = 0; n <= 193; n++) {
...
(function(n) {
    function e(a) {
        return X2n.keyCodeToStr(a);
    }
    n.toString = e;

    function t(a) {
        return X2n.strToKeyCode(a);
    }
    n.fromString = t;

    function i(a) {
        return XMo.keyCodeToStr(a);
    }
    n.toUserSettingsUS = i;

    function r(a) {
        return e2o.keyCodeToStr(a);
    }
    n.toUserSettingsGeneral = r;

    function s(a) {
        return XMo.strToKeyCode(a) || e2o.strToKeyCode(a);
    }
    n.fromUserSettings = s;
