...
Wt();
Wu();
q_a = xi("mcpProviderService");
H_a = class extends at {
  constructor(e) {
    super();
    this.experimentService = e;
    this._providers = new Map();
    this._onDidChangeProviders = this._register(new Qe());
    this.onDidChangeProviders = this._onDidChangeProviders.event;
  }
  registerMcpProvider(e) {
    if (!e.featureGateName || !!this.experimentService.checkFeatureGate(e.featureGateName)) {
...
H_a = __decorate([__param(0, Tl)], H_a);
Vi(q_a, H_a, 1);
