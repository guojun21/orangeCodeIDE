...
si(), TCt=class{
  ...
  static{
    this.OtherSuggestions=new Sn("hasOtherSuggestions", !1)
  }
  constructor(e, t){
    this._editor=e, this._index=0, this._ckOtherSuggestions=Mgi.OtherSuggestions.bindTo(t)
  }
  dispose(){
    this.reset()
  }
  ...
  static _moveIndex(e, t, i){
    let r=i;
    for(let s=t.items.length;
    s>0&&(r=(r+t.items.length+(e?1:-1))%t.items.length, !(r===i||!t.items[r].completion.additionalTextEdits));
    s--);
    return r
  }
  next(){
  ...
  _move(e){
    if(this._model)try{
      this._ignore=!0,this._index=Mgi._moveIndex(e,this._model,this._index),this._acceptNext({
        index:this._index,item:this._model.items[this._index],model:this._model
      })
    }
    finally{
      this._ignore=!1
