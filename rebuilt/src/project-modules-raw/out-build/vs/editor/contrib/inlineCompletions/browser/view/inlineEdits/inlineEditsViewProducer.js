...
v9e(), rt(), Uc(), Wt(), V$(), Ix(), ts(), EW(), q3t(), Vyg(), YSA(), kkA(), _dn(), bua=class extends at{
  static{
    Fjl=this
  }
  static{
  ...
  constructor(e, t, i, r, s){
    super(), this._editor=e, this._edit=t, this._model=i, this._focusIsInMenu=r, this._inlineEdit=Ro(this, o=>{
      ...
      const u=Ro(this,d=>{
        if(this._editorObs.isFocused.read(d)){
          if(a.tabShouldJumpToInlineEdit.read(d))return sV.Jump;
          if(a.tabShouldAcceptInlineEdit.read(d))return sV.Accept
        }
        return sV.Inactive
      });
      ...
      if(!u||!u.sourceInlineCompletion.showInlineEditMenu)return;
      const d=rh.ofLength(l.primaryGhostText.lineNumber,1);
      return new Yyg(this._editor,a,d,u)
    }), this._editorObs=HB(this._editor), this._register(s.createInstance(fua, this._editor, this._inlineEditHost, this._inlineEditModel, this._ghostTextIndicator, this._focusIsInMenu))
  }
