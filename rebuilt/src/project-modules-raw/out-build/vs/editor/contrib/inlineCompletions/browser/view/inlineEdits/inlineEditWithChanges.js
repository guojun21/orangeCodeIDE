...
zyg(), wjl=class{
  constructor(n, e, t, i, r){
    this.originalText=n, this.edit=e, this.cursorPosition=t, this.commands=i, this.inlineCompletion=r, this.lineEdit=Ugi.fromSingleTextEdit(this.edit.toSingle(this.originalText), this.originalText), this.originalLineRange=this.lineEdit.lineRange, this.modifiedLineRange=this.lineEdit.toLineEdit().getNewLineRanges()[0]
  }
  equals(n){
