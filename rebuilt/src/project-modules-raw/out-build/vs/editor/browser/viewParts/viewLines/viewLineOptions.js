...
KOn=class{
  constructor(n, e){
    this.themeType=e;
    const t=n.options, i=t.get(52);
    t.get(40)==="off"?this.renderWhitespace=t.get(104):this.renderWhitespace="none", this.renderControlCharacters=t.get(99), this.spaceWidth=i.spaceWidth, this.middotWidth=i.middotWidth, this.wsmiddotWidth=i.wsmiddotWidth, this.useMonospaceOptimizations=i.isMonospace&&!t.get(33), this.canUseHalfwidthRightwardsArrow=i.canUseHalfwidthRightwardsArrow, this.lineHeight=t.get(68), this.stopRenderingLineAfter=t.get(122), this.fontLigatures=t.get(53), this.useGpu=t.get(39)==="on"
  }
  equals(n){
