...
yn(), rt(), BCh=class PGb extends at{
  constructor(){
    super(...arguments), this._id=++PGb.idCounter, this._onDidDispose=this._register(new Qe), this.onDidDispose=this._onDidDispose.event
  }
  static{
    this.idCounter=0
  }
