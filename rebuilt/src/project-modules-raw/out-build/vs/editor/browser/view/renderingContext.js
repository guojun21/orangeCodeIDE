...
yvh=class{
  constructor(n, e){
    this._restrictedRenderingContextBrand=void 0, this._viewLayout=n, this.viewportData=e, this.scrollWidth=this._viewLayout.getScrollWidth(), this.scrollHeight=this._viewLayout.getScrollHeight(), this.visibleRange=this.viewportData.visibleRange, this.bigNumbersDelta=this.viewportData.bigNumbersDelta;
  ...
  constructor(n, e, t, i){
    super(n, e), this._renderingContextBrand=void 0, this._viewLines=t, this._viewLinesGpu=i
  }
  linesVisibleRangesForRange(n, e){
    const t=this._viewLines.linesVisibleRangesForRange(n, e);
    if(!this._viewLinesGpu)return t??null;
    const i=this._viewLinesGpu.linesVisibleRangesForRange(n, e);
    return t?i?t.concat(i).sort((r, s)=>r.lineNumber-s.lineNumber):t:i
  }
  ...
  static firstLine(n){
    if(!n)return null;
    let e=null;
    for(const t of n)(!e||t.lineNumber<e.lineNumber)&&(e=t);
    return e
  }
  static lastLine(n){
    if(!n)return null;
  ...
  constructor(n, e, t, i){
    this.outsideRenderedLine=n, this.lineNumber=e, this.ranges=t, this.continuesOnNextLine=i
  }
}, e3o=class pGb{
  static from(e){
  ...
  constructor(n, e){
    this._floatHorizontalRangeBrand=void 0, this.left=n, this.width=e
  }
  toString(){
    return`[${this.left},${this.width}]`
  }
  ...
  constructor(n, e){
    this.outsideRenderedLine=n, this.originalLeft=e, this.left=Math.round(this.originalLeft)
  }
}, t3o=class{
  constructor(n, e){
    this.outsideRenderedLine=n, this.ranges=e
  }
}
}
}), WOn, ocA=