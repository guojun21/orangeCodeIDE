...
$Se=class Lad{
  static capture(e){
    if(e.getScrollTop()===0||e.hasPendingScrollAnimation())return new Lad(e.getScrollTop(), e.getContentHeight(), null, 0, null);
    let t=null, i=0;
  ...
  constructor(e, t, i, r, s){
    this._initialScrollTop=e, this._initialContentHeight=t, this._visiblePosition=i, this._visiblePositionScrollDelta=r, this._cursorPosition=s
  }
  restore(e){
  ...
  static capture(e){
    if(e.hasPendingScrollAnimation())return new Nad(e.getScrollTop(), e.getContentHeight(), null, 0);
    let t=null, i=0;
    const r=e.getVisibleRanges();
    return r.length>0&&(t=r.at(-1).getEndPosition(), i=e.getBottomForLineNumber(t.lineNumber)-e.getScrollTop()), new Nad(e.getScrollTop(), e.getContentHeight(), t, i)
  }
  constructor(e, t, i, r){
    this._initialScrollTop=e, this._initialContentHeight=t, this._visiblePosition=i, this._visiblePositionScrollDelta=r
  }
  restore(e){
    if(!(this._initialContentHeight===e.getContentHeight()&&this._initialScrollTop===e.getScrollTop())&&this._visiblePosition){
