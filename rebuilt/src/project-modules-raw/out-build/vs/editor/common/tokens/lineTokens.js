...
tVe(), $I(), l4o(), _s(), OB=class NDt{
  static createEmpty(e, t){
    const i=NDt.defaultTokenMetadata, r=new Uint32Array(2);
    return r[0]=e.length, r[1]=i, new NDt(r, e, t)
  }
  static createFromTextAndMetadata(e, t){
    ...
    of e)s.push(i+o.length, a), i+=o.length, r+=o;
  ...
  static findIndexInTokensArray(e, t){
    ...
    i<r;
      ...
      const s=i+Math.floor((r-i)/2),o=e[s<<1];
      if(o===t)return s+1;
      o<t?i=s+1:o>t&&(r=s)
    }
    return i
  ...
  static{
    this.defaultTokenMetadata=(32768|2<<24)>>>0
  }
  constructor(e, t, i){
    this._lineTokensBrand=void 0, (e.length>1?e[e.length-2]:0)!==t.length&&Gc(new Error("Token length and text length do not match!")), this._tokens=e, this._tokensCount=this._tokens.length>>>1, this._text=t, this.languageIdCodec=i
  }
  equals(e){
    return e instanceof NDt?this.slicedEquals(e, 0, this._tokensCount):!1
  }
  slicedEquals(e, t, i){
    ...
    for(let o=r;
    o<s;
    o++)if(this._tokens[o]!==e._tokens[o])return!1;
    return!0
  }
  getLineContent(){
    return this._text
  ...
  getLanguageId(e){
    const t=this._tokens[(e<<1)+1], i=pF.getLanguageId(t);
  ...
  withInserted(e){
    ...
    ;
      ...
      if(a!==-1&&(l===null||a<=l.offset)){
        ...
        s.push(r.length,u),t++,o=a
      }
      else if(l){
        if(l.offset>o){
          r+=this._text.substring(o,l.offset);
          const u=this._tokens[(t<<1)+1];
          s.push(r.length,u),o=l.offset
        }
        r+=l.text,s.push(r.length,l.tokenMetadata),i++
      }
      else break
    }
  ...
  getTokensInRange(e){
    const t=new Slh, i=this.findTokenIndexAtOffset(e.start), r=this.findTokenIndexAtOffset(e.endExclusive);
    for(let s=i;
    s<=r;
    s++){
      const a=new dm(this.getStartOffset(s),this.getEndOffset(s)).intersectionLength(e);
      a>0&&t.add(a,this.getMetadata(s))
    }
    return t.build()
  }
  getTokenText(e){
  ...
  extractObject(){
    return{
      tokens:this._tokens,text:this._text
    }
  }
  toString(){
    let e="";
  ...
  constructor(e, t, i, r){
    this._source=e, this._startOffset=t, this._endOffset=i, this._deltaOffset=r, this._firstTokenIndex=e.findTokenIndexAtOffset(t), this.languageIdCodec=e.languageIdCodec, this._tokensCount=0;
    for(let s=this._firstTokenIndex, o=e.getCount();
    s<o&&!(e.getStartOffset(s)>=i);
    s++)this._tokensCount++
  }
  getMetadata(e){
  ...
  equals(e){
    return e instanceof PJb?this._startOffset===e._startOffset&&this._endOffset===e._endOffset&&this._deltaOffset===e._deltaOffset&&this._source.slicedEquals(e._source, this._firstTokenIndex, this._tokensCount):!1
  }
  getCount(){
    return this._tokensCount
  }
  ...
  getTokenText(e){
    const t=this._firstTokenIndex+e, i=this._source.getStartOffset(t), r=this._source.getEndOffset(t);
    let s=this._source.getTokenText(t);
    return i<this._startOffset&&(s=s.substring(this._startOffset-i)), r>this._endOffset&&(s=s.substring(0, s.length-(r-this._endOffset))), s
  }
  forEach(e){
    for(let t=0;
    t<this.getCount();
...
function n1c(n, e){
  n.tokenization.forceTokenization(e.lineNumber);
  const t=n.tokenization.getLineTokens(e.lineNumber), i=Zgt(t, e.column-1), r=i.firstCharOffset===0, s=t.getLanguageId(0)===i.languageId;
  return!r&&!s
}
var u4o, d4o, i1c, r1c=