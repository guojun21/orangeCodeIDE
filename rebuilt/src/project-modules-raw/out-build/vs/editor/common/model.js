...
np(), rOn(), (function(n){
  ...
  n[n.Normal=1]="Normal", n[n.Underlined=2]="Underlined"
})(eph||(eph={
  ...
  constructor(n){
    this._textModelResolvedOptionsBrand=void 0, this.tabSize=Math.max(1, n.tabSize|0), n.indentSize==="tabSize"?(this.indentSize=this.tabSize, this._indentSizeIsTabSize=!0):(this.indentSize=Math.max(1, n.indentSize|0), this._indentSizeIsTabSize=!1), this.insertSpaces=!!n.insertSpaces, this.defaultEOL=n.defaultEOL|0, this.trimAutoWhitespace=!!n.trimAutoWhitespace, this.bracketPairColorizationOptions=n.bracketPairColorizationOptions
  }
  equals(n){
  ...
  createChangeEvent(n){
    return{
      tabSize:this.tabSize!==n.tabSize,indentSize:this.indentSize!==n.indentSize,insertSpaces:this.insertSpaces!==n.insertSpaces,trimAutoWhitespace:this.trimAutoWhitespace!==n.trimAutoWhitespace
    }
  }
}, SOt=class{
  constructor(n, e){
    this._findMatchBrand=void 0, this.range=n, this.matches=e
  }
}, (function(n){
  ...
  topPromptBarData:{
    selections:[], selectedDocs:[], lastGenerationUUID:void 0, diffIds:[], initText:"", userBubbleDelegate:new Z5e, shown:!1
  }
}), (function(n){
  ...
  n[n.FIRST_LINE_DETECTION_LENGTH_LIMIT=1e3]="FIRST_LINE_DETECTION_LENGTH_LIMIT"
})(aph||(aph={
  
})), sOn=class{
  constructor(n, e, t, i, r, s){
    this.identifier=n, this.range=e, this.text=t, this.forceMoveMarkers=i, this.isAutoWhitespaceEdit=r, this._isTracked=s
  }
}, cph=class{
  constructor(n, e, t){
    this.regex=n, this.wordSeparators=e, this.simpleSearch=t
  }
}, lph=class{
  constructor(n, e, t){
    this.reverseEdits=n, this.changes=e, this.trimAutoWhitespaceLineNumbers=t
  }
}
}
}), kEc, uph, dph, SoA=