...
iDf(), Nu(), cu(), Yn(), yn(), Js(), exe(), Yr(), d2(), rt(), ri(), fD=class BWa extends dfu{
  static{
  ...
  get window(){
    return Coe(this.group.windowId, !0).window
  }
  get scopedContextKeyService(){
    
  }
  constructor(e, t, i, r, s){
    super(e, i, r, s), this.group=t, this.onDidChangeSizeConstraints=In.None, this._onDidChangeControl=this._register(new Qe), this.onDidChangeControl=this._onDidChangeControl.event
  }
  create(e){
  ...
  setVisible(e){
    super.setVisible(e), this.setEditorVisible(e)
  }
  setEditorVisible(e){
  ...
  getEditorMemento(e, t, i, r=10){
    ...
    return o||(o=this._register(new rDf(this.getId(), i, this.getMemento(1, 1), r, e, t)), BWa.EDITOR_MEMENTOS.set(s, o)), o
  }
  getViewState(){
    
  }
  saveState(){
    for(const[, e]of BWa.EDITOR_MEMENTOS)e.id===this.getId()&&e.saveState();
    super.saveState()
  }
  dispose(){
  ...
  saveEditorState(e, t, i){
    ...
    o||(o=Object.create(null), s.set(r.toString(), o)), o[e.id]=i, this.shareEditorState&&(o[RWa.SHARED_EDITOR_STATE]=i), D_(t)&&this.clearEditorStateOnDispose(r, t)
  }
  loadEditorState(e, t){
    ...
    if(s){
      const o=s[e.id];
      if(o)return o;
      if(this.shareEditorState)return s[RWa.SHARED_EDITOR_STATE]
    }
  }
  clearEditorState(e, t){
    D_(e)&&this.editorDisposables?.delete(e);
    const i=this.doGetResource(e);
    if(i){
      const r=this.doLoad();
      if(t){
        const s=r.get(i.toString());
        s&&(delete s[t.id],xbe(s)&&r.delete(i.toString()))
      }
      else r.delete(i.toString())
    }
  }
  clearEditorStateOnDispose(e, t){
    this.editorDisposables||(this.editorDisposables=new Map), this.editorDisposables.has(t)||this.editorDisposables.set(t, In.once(t.onWillDispose)(()=>{
      this.clearEditorState(e),this.editorDisposables?.delete(t)
    }))
  }
  moveEditorState(e, t, i){
    ...
    for(const o of s){
      const a=je.parse(o);
      if(!i.isEqualOrParent(a,e))continue;
      let l;
      if(Zc(e,a))l=t;
      else{
      ...
      const u=r.get(o,0);
      u&&(r.delete(o),r.set(l.toString(),u))
    }
  }
  doGetResource(e){
    return D_(e)?e.resource:e
  }
  doLoad(){
    if(!this.cache){
  ...
  cleanUp(){
    ...
    for(const[i, r]of t)for(const s of Object.keys(r)){
      const o=Number(s);
      o===RWa.SHARED_EDITOR_STATE&&this.shareEditorState||this.editorGroupService.getGroup(o)||(delete r[o],xbe(r)&&e.delete(i))
    }
  }
}
}
