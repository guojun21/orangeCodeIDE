...
jr(), rt(), Ei(), l2(), fka=class extends at{
  constructor(e, t){
    super(), this.logService=e, this.configurationService=t, this.participants=new WD
  }
  ...
  async participate(e, t, i, r){
    ...
    if(!(typeof s!="number"||s<=0))for(const o of this.participants)try{
