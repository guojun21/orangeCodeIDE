...
yn(), rt(), Bc(), UVe(), N9f(), z0(), Dki=class extends at{
  get id(){
    return this._id
  }
  get outputs(){
  ...
  constructor(e, t){
    super(), this.textModel=e, this._notebookService=t, this._onDidChangeState=this._register(new Qe), this._hoveringOutput=!1, this._focusOnOutput=!1, this._focusInputInOutput=!1, this._outputCollection=[], this._outputsTop=null, this._onDidChangeOutputLayout=this._register(new Qe), this.onDidChangeOutputLayout=this._onDidChangeOutputLayout.event, this._id=Wr(), this._outputViewModels=this.textModel.outputs.map(i=>new GSi(this, i, this._notebookService)), this._register(this.textModel.onDidChangeOutputs(i=>{
      this._outputCollection.splice(i.start,i.deleteCount,...i.newOutputs.map(()=>0)),this._outputViewModels.splice(i.start,i.deleteCount,...i.newOutputs.map(s=>new GSi(this,s,this._notebookService))).forEach(s=>s.dispose()),this._outputsTop=null,this._onDidChangeOutputLayout.fire()
  ...
  updateOutputHeight(e, t){
    ...
    this._ensureOutputsTop(), this._outputCollection[e]=t, this._outputsTop.setValue(e, t)&&this._onDidChangeOutputLayout.fire()
  }
  getOutputTotalHeight(){
    return this._ensureOutputsTop(), this._outputsTop?.getTotalSum()??0
  }
  dispose(){
    super.dispose(), this._outputViewModels.forEach(e=>{
      e.dispose()
    })
  }
