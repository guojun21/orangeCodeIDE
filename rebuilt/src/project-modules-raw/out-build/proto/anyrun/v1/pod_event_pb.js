...
Ka(), (function(n){
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.DOCKER_BUILD=1]="DOCKER_BUILD", n[n.WORKSPACE_SETUP=2]="WORKSPACE_SETUP"
})(zSt||(zSt={
  ...
  constructor(e){
    super(), this.tenantId="", this.podId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.creationTimestamp=Eo.zero, this.payload={
      case:void 0
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:49,name:"creation_timestamp",kind:"scalar",T:4
    }, {
      no:26,name:"error",kind:"message",T:ZGg,oneof:"payload"
    }, {
      no:1,name:"debug_event",kind:"scalar",T:9,oneof:"payload"
    }, {
      no:43,name:"hydration_started",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:44,name:"hydration_progress",kind:"message",T:YGg,oneof:"payload"
    }, {
      no:45,name:"hydration_completed",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:31,name:"clone_started",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:32,name:"clone_completed",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:51,name:"clone_started_v2",kind:"message",T:aWg,oneof:"payload"
    }, {
      no:52,name:"clone_completed_v2",kind:"message",T:cWg,oneof:"payload"
    }, {
      no:33,name:"checkout_started",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:34,name:"checkout_completed",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:2,name:"build_started",kind:"scalar",T:9,oneof:"payload"
    }, {
      no:3,name:"build_status_message",kind:"scalar",T:9,oneof:"payload"
    }, {
      no:27,name:"build_step_started",kind:"message",T:XGg,oneof:"payload"
    }, {
      no:28,name:"build_status_line",kind:"message",T:eWg,oneof:"payload"
    }, {
      no:29,name:"internal_build_message",kind:"message",T:tWg,oneof:"payload"
    }, {
      ...
      no:50,name:"install_command",kind:"message",T:oWg,oneof:"payload"
    }, {
      ...
      no:20,name:"extension_install_stdout",kind:"message",T:Zvi,oneof:"payload"
    }, {
      no:21,name:"extension_install_stderr",kind:"message",T:Zvi,oneof:"payload"
    }, {
      no:22,name:"extension_install_exit_code",kind:"message",T:osu,oneof:"payload"
    }, {
      no:35,name:"snapshot_started",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:36,name:"snapshot_completed",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:9,name:"creation_completed",kind:"message",T:ZI,oneof:"payload"
    }, {
      ...
      no:23,name:"extension_start_stdout",kind:"message",T:Zvi,oneof:"payload"
    }, {
      no:24,name:"extension_start_stderr",kind:"message",T:Zvi,oneof:"payload"
    }, {
      no:25,name:"extension_start_exit_code",kind:"message",T:osu,oneof:"payload"
    }, {
      no:13,name:"startup_completed",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:37,name:"image_pull_started",kind:"message",T:nWg,oneof:"payload"
    }, {
      no:38,name:"image_pull_layer_update",kind:"message",T:iWg,oneof:"payload"
    }, {
      no:39,name:"image_pull_status_update",kind:"message",T:rWg,oneof:"payload"
    }, {
      no:40,name:"image_pull_completed",kind:"message",T:sWg,oneof:"payload"
    }, {
      no:41,name:"blocked_repo_state",kind:"message",T:VGg,oneof:"payload"
    }, {
      no:42,name:"acquired_repo_state",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:53,name:"private_worker_ready",kind:"message",T:ZI,oneof:"payload"
    }, {
      no:54,name:"waiting_for_worker",kind:"message",T:KGg,oneof:"payload"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.retryCount=0, this.maxRetries=0, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"retry_count",kind:"scalar",T:5
    }, {
      no:2,name:"max_retries",kind:"scalar",T:5
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.transferred=Eo.zero, this.total=Eo.zero, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"transferred",kind:"scalar",T:4
    }, {
      no:2,name:"total",kind:"scalar",T:4
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.featureId="", this.output="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"feature_id",kind:"scalar",T:9
    }, {
      no:2,name:"output",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.featureId="", this.exitCode=Eo.zero, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"exit_code",kind:"scalar",T:3
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.streamId=0, this.step=0, this.totalSteps=0, this.command="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"stream_id",kind:"scalar",T:13
    }, {
      no:2,name:"step",kind:"scalar",T:13
    }, {
      no:3,name:"total_steps",kind:"scalar",T:13
    }, {
  ...
  constructor(e){
    super(), this.streamId=0, this.timestamp="", this.content="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"timestamp",kind:"scalar",T:9
    }, {
  ...
  constructor(e){
    super(), this.streamId=0, this.content="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.imageName="", this.pullId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"image_name",kind:"scalar",T:9
    }, {
      no:2,name:"pull_id",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.imageName="", this.pullId="", this.layerId="", this.status={
      case:void 0
    }, v.util.initPartial(e, this)
  }
  static{
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"layer_id",kind:"scalar",T:9
    }, {
      ...
      no:9,name:"downloading",kind:"message",T:asu,oneof:"status"
    }, {
      no:10,name:"extracting",kind:"message",T:asu,oneof:"status"
    }, {
  ...
  constructor(e){
    super(), this.current=Eo.zero, this.total=Eo.zero, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"current",kind:"scalar",T:4
    }, {
      no:2,name:"total",kind:"scalar",T:4
    }
    ])
  ...
  constructor(e){
    super(), this.imageName="", this.pullId="", this.status="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"user",kind:"scalar",T:9,opt:!0
    }, {
  ...
  constructor(e){
    super(), this.purpose=zSt.UNSPECIFIED, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"purpose",kind:"enum",T:v.getEnumType(zSt)
    }
    ])
  }
  static fromBinary(e, t){
