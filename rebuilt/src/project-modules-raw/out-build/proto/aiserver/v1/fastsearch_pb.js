...
Ka(), qp(), JIa=class Bto extends ie{
  constructor(e){
    super(), this.relativeWorkspacePath="", this.hash="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.uuid="", this.openTabs=[], this.contextGraphFiles=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"open_tabs",kind:"message",T:JIa,repeated:!0
    }, {
      no:4,name:"context_graph_files",kind:"message",T:JIa,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"ready",kind:"message",T:r0u,oneof:"response"
    }, {
      no:2,name:"missing_files",kind:"message",T:Y6f,oneof:"response"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"file_chunks",kind:"message",T:X6f,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.chunkScore=0, this.contents="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"chunk",kind:"message",T:tEh
    }, {
