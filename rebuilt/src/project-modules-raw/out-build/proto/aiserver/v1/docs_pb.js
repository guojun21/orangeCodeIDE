...
Ka(), oMc=class Q$i extends ie{
  constructor(e){
    super(), this.prefixUrl="", this.docName="", this.isDifferentPrefixOrigin=!1, this.truePrefixUrl="", this.public=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.docName="", this.pageUrl="", this.documentationChunk="", this.score=0, this.pageTitle="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.docIdentifier="", this.query="", this.topK=0, this.rerankResults=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.docIdentifier="", this.docName="", this.docChunks=[], this.status=K9n.UNSPECIFIED, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"doc_chunks",kind:"message",T:aMc,repeated:!0
    }, {
      no:4,name:"status",kind:"enum",T:v.getEnumType(K9n)
    }
    ])
  }
  static fromBinary(e, t){
  ...
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.NOT_FOUND=1]="NOT_FOUND", n[n.SUCCESS=2]="SUCCESS", n[n.FAILURE=3]="FAILURE"
})(K9n||(K9n={
...
}), BIh, ko, VY, RIh, PIh, LIh, NIh, MIh, FIh, OIh, UIh, $Ih, qIh, HIh, JIh, GIh, WIh, QIh, jIh, zIh, VIh, KIh, YIh, Uv=