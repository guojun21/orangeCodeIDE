...
Ka(), qp(), jY(), h8A=class mws extends ie{
  constructor(e){
  ...
  constructor(e){
    super(), this.repositories=[], this.contextBlocks=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:6,name:"repositories",kind:"message",T:z_,repeated:!0
    }, {
      no:7,name:"context_blocks",kind:"message",T:Xtf,repeated:!0
    }, {
      no:13,name:"explicit_context",kind:"message",T:_F
    }, {
      no:14,name:"model_details",kind:"message",T:Yf
    }, {
      no:15,name:"linter_errors",kind:"message",T:aN
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.contextType=_yi.UNSPECIFIED, this.blocks=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"context_type",kind:"enum",T:v.getEnumType(_yi)
    }, {
      no:2,name:"blocks",kind:"message",T:WB,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.RECENT_LOCATIONS=1]="RECENT_LOCATIONS"
})(_yi||(_yi={
