...
Ka(), qp(), cv(), (function(n){
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.ACCEPTED=1]="ACCEPTED", n[n.REJECTED=2]="REJECTED", n[n.PARTIALLY_ACCEPTED=3]="PARTIALLY_ACCEPTED"
})(X6o||(X6o={
  ...
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.COMPOSER=1]="COMPOSER", n[n.CLICKED_APPLY=2]="CLICKED_APPLY", n[n.CACHED_APPLY=3]="CACHED_APPLY", n[n.COMPOSER_AGENT=4]="COMPOSER_AGENT"
})(u9t||(u9t={
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"fate",kind:"enum",T:v.getEnumType(X6o),opt:!0
    }, {
      no:3,name:"num_accepted_partial_diffs",kind:"scalar",T:5,opt:!0
    }, {
      no:4,name:"num_rejected_partial_diffs",kind:"scalar",T:5,opt:!0
    }
    ])
  }
  ...
  constructor(e){
    super(), this.conversation=[], this.source=u9t.UNSPECIFIED, this.willingToPayExtraForSpeed=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:5,name:"source",kind:"enum",T:v.getEnumType(u9t)
    }, {
...
}), lvt, uvt, j4c, gOh, fOh, d9t, bOh, vOh, AOh, yOh, wOh, _Oh, eUo, COh, SOh, Z8n, kOh, BgA, RgA, EOh, xOh=