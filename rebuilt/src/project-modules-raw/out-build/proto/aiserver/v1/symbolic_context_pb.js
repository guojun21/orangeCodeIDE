...
Ka(), qp(), ixh=class zFi extends ie{
  constructor(e){
    super(), this.files=[], this.targetDir="", this.repo="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.indexId="", this.files=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"files",kind:"message",T:WRc,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"ready",kind:"message",T:cxh,oneof:"item"
    }, {
      no:3,name:"register",kind:"message",T:lxh,oneof:"item"
    }, {
      no:4,name:"choose",kind:"message",T:uxh,oneof:"item"
    }, {
      no:5,name:"summarize",kind:"message",T:dxh,oneof:"item"
    }, {
      no:6,name:"error",kind:"message",T:hxh,oneof:"item"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"request",kind:"message",T:JRc
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"response",kind:"message",T:mxh
    }, {
      no:2,name:"request",kind:"message",T:X9o
    }, {
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"response",kind:"message",T:yxh
    }, {
      no:2,name:"request",kind:"message",T:e8o
    }, {
      no:3,name:"req_uuid",kind:"scalar",T:9
    }
    ])
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"response",kind:"message",T:Sxh
    }, {
      no:2,name:"request",kind:"message",T:t8o
    }, {
      no:3,name:"req_uuid",kind:"scalar",T:9
    }
    ])
  ...
  constructor(e){
    super(), this.message="", this.statusCode=0, this.request={
      case:void 0
    }, this.reqUuid="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"register",kind:"message",T:X9o,oneof:"request"
    }, {
      no:4,name:"choose",kind:"message",T:e8o,oneof:"request"
    }, {
      no:5,name:"summarize",kind:"message",T:t8o,oneof:"request"
    }, {
  ...
  constructor(e){
    super(), this.indexId="", this.workspaceRelativePath="", this.content=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"root_context_node",kind:"message",T:Txh
    }, {
  ...
  constructor(e){
    super(), this.fileId="", this.rootContextNodeId="", this.dependencyResolutionAttempts=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"dependency_resolution_attempts",kind:"message",T:jRc,repeated:!0
    }, {
      no:4,name:"file_data",kind:"message",T:WRc
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.indexId="", this.fileId="", this.dependencyResolutionResults=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"dependency_resolution_results",kind:"message",T:Ixh,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.indexId="", this.request={
      case:void 0
    }, this.recompute=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"file",kind:"message",T:vxh,oneof:"request"
    }, {
      no:3,name:"node",kind:"message",T:Axh,oneof:"request"
    }, {
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"file",kind:"message",T:wxh,oneof:"response"
    }, {
      no:2,name:"node",kind:"message",T:GRc,oneof:"response"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.nodeId="", this.actions=[], this.skipped=!1, this.dependencies=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"actions",kind:"message",T:N5n,repeated:!0
    }, {
  ...
  constructor(e){
    super(), this.fileId="", this.nodeResponses=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"node_responses",kind:"message",T:GRc,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.nodeId="", this.references=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"references",kind:"message",T:Rxh,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.indexId="", this.nodeId="", this.recompute=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.response={
      case:void 0
    }, this.nodeId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:kxh,oneof:"response"
    }, {
      no:2,name:"dependency",kind:"message",T:Exh,oneof:"response"
    }, {
  ...
  constructor(e){
    super(), this.indexId="", this.id="", this.summary="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.indexId="", this.workspaceRelativePath="", this.stage="", this.order=0, this.nodes=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:5,name:"nodes",kind:"message",T:QRc,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.nodeId="", this.stage="", this.content="", this.summary="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.workspaceRelativePath="", this.startLineNumber=0, this.endLineNumber=0, this.children=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:4,name:"children",kind:"message",T:iSn,repeated:!0
    }, {
      no:5,name:"node_snippets",kind:"message",T:i8o
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.workspaceRelativePath="", this.nodeId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"symbol",kind:"message",T:N5n
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"request",kind:"message",T:jRc
    }, {
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"file_code_snippets",kind:"message",T:i8o
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"paths",kind:"message",T:N5n,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"action",kind:"message",T:N5n
    }, {
      no:2,name:"references",kind:"message",T:Pxh,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"reference",kind:"message",T:i8o
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.relativeWorkspacePath="", this.totalLines=0, this.snippets=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"snippets",kind:"message",T:Lxh,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.startLineNumber=0, this.endLineNumber=0, this.lines=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  constructor(e){
    super(), this.workspaceRelativePath="", this.lineNumber=0, this.symbolStartColumn=0, this.symbolEndColumn=0, this.action=M5n.UNSPECIFIED, this.symbol="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:5,name:"action",kind:"enum",T:v.getEnumType(M5n)
    }, {
  ...
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.GO_TO_DEFINITION=1]="GO_TO_DEFINITION", n[n.GO_TO_IMPLEMENTATION=2]="GO_TO_IMPLEMENTATION", n[n.REFERENCES=3]="REFERENCES"
})(M5n||(M5n={
...
}), r8o, Fbt, Obt, F5n, s8o, o8o, Mxh, Fxh, Oxh, Uxh, $xh, vve, qxh, Hxh, O5n, Jxh, Gxh, Wxh, Qxh, U5n, jxh, $5n, zxh, q5n, Vxh, Kxh, Yxh, Zxh, Xxh, zRc, eTh, tTh, VRc, nTh, iTh, H5n, rTh, sTh, J5n, oTh, Ubt, KRc, aTh, cTh, G5n, lTh, uTh, dTh, hTh, mTh, pTh, gTh, fTh, bTh, bpA, vpA, ApA, ypA, wpA, _pA, W5n, CpA, SpA, Q5n, kpA, EpA, j5n, xpA, TpA, z5n, IpA, DpA, V5n, BpA, RpA, K5n, PpA, LpA, NpA, MpA, Y5n, FpA, OpA, Z5n, YRc, vTh, X5n, UpA, $pA, e9n, ZRc, $bt, zR, ATh, XRc, ePc, tPc, yTh, nPc, wTh, qpA, HpA, JpA, GpA, WpA, QpA, t9n, jpA, zpA, n9n, VpA, KpA, YpA, ZpA, i9n, _Th, CTh, STh, kTh, ETh, xTh, TTh, ITh, DTh, BTh, iPc, z_, XpA, RTh, PTh, LTh, NTh, MTh, FTh, OTh, r9n, a8o, UTh, $Th, qTh, HTh, JTh, s9n, GTh, WTh, o9n, QTh, a9n, jTh, zTh, VTh, KTh, YTh, ZTh, XTh, eIh, c9n, tIh, nIh, l9n, jY=