...
Ka(), L9e(), v6o=class QJi extends ie{
  constructor(e){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:YBh,oneof:"result"
    }, {
      no:2,name:"error",kind:"message",T:ZBh,oneof:"result"
    }, {
      no:3,name:"rejected",kind:"message",T:XBh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.url="", this.markdown="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"markdown",kind:"scalar",T:9
    }, {
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"args",kind:"message",T:v6o
    }, {
      no:2,name:"result",kind:"message",T:f2c
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.skipApproval=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"skip_approval",kind:"scalar",T:8
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"approved",kind:"message",T:nRh,oneof:"result"
    }, {
      no:2,name:"rejected",kind:"message",T:iRh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
...
}), v2c, sRh, oRh, A2c, aRh, cRh, lRh, uRh, dRh, hRh, mRh, ogA=