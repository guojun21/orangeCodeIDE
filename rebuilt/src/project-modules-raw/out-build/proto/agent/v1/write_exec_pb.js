...
Ka(), qNh=class MKi extends ie{
  constructor(e){
    super(), this.path="", this.fileText="", this.toolCallId="", this.returnFileContentAfterWrite=!1, this.fileBytes=new Uint8Array(0), v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"file_text",kind:"scalar",T:9
    }, {
      no:3,name:"tool_call_id",kind:"scalar",T:9
    }, {
      no:4,name:"return_file_content_after_write",kind:"scalar",T:8
    }, {
      no:5,name:"file_bytes",kind:"scalar",T:12
    }
    ])
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:JNh,oneof:"result"
    }, {
      no:3,name:"permission_denied",kind:"message",T:GNh,oneof:"result"
    }, {
      no:4,name:"no_space",kind:"message",T:WNh,oneof:"result"
    }, {
      no:5,name:"error",kind:"message",T:QNh,oneof:"result"
    }, {
      no:6,name:"rejected",kind:"message",T:jNh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.path="", this.linesCreated=0, this.fileSize=0, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"lines_created",kind:"scalar",T:5
    }, {
      no:3,name:"file_size",kind:"scalar",T:5
    }, {
      no:4,name:"file_content_after_write",kind:"scalar",T:9,opt:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.path="", this.directory="", this.operation="", this.error="", this.isReadonly=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"directory",kind:"scalar",T:9
    }, {
      no:3,name:"operation",kind:"scalar",T:9
    }, {
      no:4,name:"error",kind:"scalar",T:9
    }, {
      no:5,name:"is_readonly",kind:"scalar",T:8
    }
    ])
  }
  static fromBinary(e, t){
...
}), XFc, zNh, VNh, KNh, YNh, ZNh, XNh, eMh, tMh=