...
Ka(), (function(n){
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.DEFAULT=1]="DEFAULT", n[n.READONLY=2]="READONLY"
})(Y9n||(Y9n={
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"unspecified",kind:"message",T:cMc,oneof:"type"
    }, {
      no:2,name:"computer_use",kind:"message",T:lMc,oneof:"type"
    }, {
      no:3,name:"custom",kind:"message",T:bMc,oneof:"type"
    }, {
      no:4,name:"explore",kind:"message",T:uMc,oneof:"type"
    }, {
      no:5,name:"media_review",kind:"message",T:dMc,oneof:"type"
    }, {
      no:6,name:"bash",kind:"message",T:hMc,oneof:"type"
    }, {
      no:7,name:"browser_use",kind:"message",T:pMc,oneof:"type"
    }, {
      no:8,name:"shell",kind:"message",T:mMc,oneof:"type"
    }, {
      no:9,name:"vm_setup_helper",kind:"message",T:gMc,oneof:"type"
    }, {
      no:10,name:"debug",kind:"message",T:fMc,oneof:"type"
    }
    ])
  }
  ...
  constructor(e){
    super(), this.fullPath="", this.name="", this.description="", this.tools=[], this.model="", this.prompt="", this.permissionMode=Y9n.UNSPECIFIED, this.isBackground=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:4,name:"tools",kind:"scalar",T:9,repeated:!0
    }, {
      no:5,name:"model",kind:"scalar",T:9
    }, {
      no:6,name:"prompt",kind:"scalar",T:9
    }, {
      no:7,name:"permission_mode",kind:"enum",T:v.getEnumType(Y9n)
    }, {
      no:8,name:"is_background",kind:"scalar",T:8
    }, {
