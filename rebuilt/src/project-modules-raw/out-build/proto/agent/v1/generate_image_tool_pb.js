...
Ka(), L5n=class OFi extends ie{
  constructor(e){
    super(), this.description="", this.referenceImagePaths=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"file_path",kind:"scalar",T:9,opt:!0
    }, {
      no:5,name:"reference_image_paths",kind:"scalar",T:9,repeated:!0
    }
    ])
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:ZEh,oneof:"result"
    }, {
      no:2,name:"error",kind:"message",T:XEh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.filePath="", this.imageData="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"image_data",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"args",kind:"message",T:L5n
    }, {
      no:2,name:"result",kind:"message",T:l5t
    }
    ])
  }
  static fromBinary(e, t){
