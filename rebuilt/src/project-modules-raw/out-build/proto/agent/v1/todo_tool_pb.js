...
Ka(), (function(n){
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.PENDING=1]="PENDING", n[n.IN_PROGRESS=2]="IN_PROGRESS", n[n.COMPLETED=3]="COMPLETED", n[n.CANCELLED=4]="CANCELLED"
})(KY||(KY={
  ...
  constructor(e){
    super(), this.id="", this.content="", this.status=KY.UNSPECIFIED, this.createdAt=Eo.zero, this.updatedAt=Eo.zero, this.dependencies=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"status",kind:"enum",T:v.getEnumType(KY)
    }, {
      no:4,name:"created_at",kind:"scalar",T:3
    }, {
      no:5,name:"updated_at",kind:"scalar",T:3
    }, {
      no:6,name:"dependencies",kind:"scalar",T:9,repeated:!0
    }
    ])
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"args",kind:"message",T:DMc
    }, {
      no:2,name:"result",kind:"message",T:BMc
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"todos",kind:"message",T:U9e,repeated:!0
    }, {
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:RMc,oneof:"result"
    }, {
      no:2,name:"error",kind:"message",T:SDh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.todos=[], this.totalCount=0, this.wasMerge=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"was_merge",kind:"scalar",T:8
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"args",kind:"message",T:EDh
    }, {
      no:2,name:"result",kind:"message",T:xDh
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.statusFilter=[], this.idFilter=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"status_filter",kind:"enum",T:v.getEnumType(KY),repeated:!0
    }, {
      no:2,name:"id_filter",kind:"scalar",T:9,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:TDh,oneof:"result"
    }, {
      no:2,name:"error",kind:"message",T:IDh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.todos=[], this.totalCount=0, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
...
}), n8n, ake, i8n, DDh, BDh, RDh, PDh, Kbt, Ave, PMc, c6o=