...
Ka(), r6o(), e8n=class m7i extends ie{
  constructor(e){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"args",kind:"message",T:s6o
    }, {
      no:2,name:"result",kind:"message",T:t8n
    }
    ])
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:5,name:"include_line_numbers",kind:"scalar",T:8,opt:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:TMc,oneof:"result"
    }, {
  ...
  constructor(e){
    super(), this.startLine=0, this.endLine=0, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"start_line",kind:"scalar",T:13
    }, {
      no:2,name:"end_line",kind:"scalar",T:13
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.output={
      case:void 0
    }, this.isEmpty=!1, this.exceededLimit=!1, this.totalLines=0, this.fileSize=0, this.path="", this.relatedCursorRulePaths=[], this.relatedCursorRules=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"is_empty",kind:"scalar",T:8
    }, {
      no:3,name:"exceeded_limit",kind:"scalar",T:8
    }, {
      no:4,name:"total_lines",kind:"scalar",T:13
    }, {
      no:5,name:"file_size",kind:"scalar",T:13
    }, {
      no:7,name:"path",kind:"scalar",T:9
    }, {
      no:8,name:"read_range",kind:"message",T:_Dh,opt:!0
    }, {
      no:11,name:"include_line_numbers",kind:"scalar",T:8,opt:!0
    }, {
      no:12,name:"related_cursor_rule_paths",kind:"scalar",T:9,repeated:!0
    }, {
      no:13,name:"related_cursor_rules",kind:"message",T:X9n,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
...
}), KY, U9e, IMc, DMc, BMc, RMc, SDh, kDh, EDh, xDh, TDh, IDh, a6o=