...
Ka(), LBh=class xJi extends ie{
  constructor(e){
    super(), this.unexpectedActionOutcomes="", this.relevantInstructions="", this.scenarioAnalysis="", this.criticalSynthesis="", this.nextSteps="", this.toolCallId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"unexpected_action_outcomes",kind:"scalar",T:9
    }, {
      no:2,name:"relevant_instructions",kind:"scalar",T:9
    }, {
      no:3,name:"scenario_analysis",kind:"scalar",T:9
    }, {
      no:4,name:"critical_synthesis",kind:"scalar",T:9
    }, {
      no:5,name:"next_steps",kind:"scalar",T:9
    }, {
      no:6,name:"tool_call_id",kind:"scalar",T:9
    }
    ])
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:MBh,oneof:"result"
    }, {
      no:2,name:"error",kind:"message",T:FBh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"args",kind:"message",T:LBh
    }, {
      no:2,name:"result",kind:"message",T:NBh
    }
    ])
  }
  static fromBinary(e, t){
