...
Ka(), (function(n){
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.START_RECORDING=1]="START_RECORDING", n[n.SAVE_RECORDING=2]="SAVE_RECORDING", n[n.DISCARD_RECORDING=3]="DISCARD_RECORDING"
})(PKe||(PKe={
  ...
  n[n.UNSPECIFIED=0]="UNSPECIFIED", n[n.SLASHES_NOT_ALLOWED=1]="SLASHES_NOT_ALLOWED"
})(Y9o||(Y9o={
  ...
  constructor(e){
    super(), this.mode=PKe.UNSPECIFIED, this.toolCallId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"mode",kind:"enum",T:v.getEnumType(PKe)
    }, {
      no:2,name:"tool_call_id",kind:"scalar",T:9
    }, {
      no:3,name:"save_as_filename",kind:"scalar",T:9,opt:!0
    }
    ])
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"start_success",kind:"message",T:QEh,oneof:"result"
    }, {
      no:2,name:"save_success",kind:"message",T:jEh,oneof:"result"
    }, {
      no:3,name:"discard_success",kind:"message",T:zEh,oneof:"result"
    }, {
      no:4,name:"failure",kind:"message",T:VEh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.wasPriorRecordingCancelled=!1, this.wasSaveAsFilenameIgnored=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"was_prior_recording_cancelled",kind:"scalar",T:8
    }, {
      no:2,name:"was_save_as_filename_ignored",kind:"scalar",T:8
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.path="", this.recordingDurationMs=Eo.zero, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"recording_duration_ms",kind:"scalar",T:3
    }, {
      no:3,name:"requested_file_path_rejected_reason",kind:"enum",T:v.getEnumType(Y9o),opt:!0
    }
    ])
  }
  static fromBinary(e, t){
...
}), FRc, ORc, B5n, KEh, URc, R5n, YEh, P5n=