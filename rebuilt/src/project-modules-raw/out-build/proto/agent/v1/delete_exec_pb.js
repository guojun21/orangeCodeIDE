...
Ka(), J5t=class Pqi extends ie{
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"file_not_found",kind:"message",T:nDh,oneof:"result"
    }, {
      no:3,name:"not_file",kind:"message",T:iDh,oneof:"result"
    }, {
      no:4,name:"permission_denied",kind:"message",T:rDh,oneof:"result"
    }, {
      no:5,name:"file_busy",kind:"message",T:sDh,oneof:"result"
    }, {
      no:6,name:"rejected",kind:"message",T:oDh,oneof:"result"
    }, {
      no:7,name:"error",kind:"message",T:aDh,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.path="", this.deletedFile="", this.fileSize=Eo.zero, this.prevContent="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"deleted_file",kind:"scalar",T:9
    }, {
      no:3,name:"file_size",kind:"scalar",T:3
    }, {
      no:4,name:"prev_content",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.path="", this.actualType="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"actual_type",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.path="", this.clientVisibleError="", this.isReadonly=!1, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"client_visible_error",kind:"scalar",T:9
    }, {
