...
Ka(), n2c=class eJi extends ie{
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"result",kind:"message",T:cke
    }
    ])
  }
  ...
  constructor(e){
    super(), this.title="", this.questions=[], this.runAsync=!1, this.asyncOriginalToolCallId="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"questions",kind:"message",T:i2c,repeated:!0
    }, {
      no:5,name:"run_async",kind:"scalar",T:8
    }, {
      no:6,name:"async_original_tool_call_id",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"options",kind:"message",T:r2c,repeated:!0
    }, {
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"success",kind:"message",T:d8n,oneof:"result"
    }, {
      no:2,name:"error",kind:"message",T:wBh,oneof:"result"
    }, {
      no:3,name:"rejected",kind:"message",T:f6o,oneof:"result"
    }, {
      no:4,name:"async",kind:"message",T:s2c,oneof:"result"
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.answers=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"answers",kind:"message",T:g6o,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  constructor(e){
    super(), this.questionId="", this.selectedOptionIds=[], this.freeformText="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:3,name:"freeform_text",kind:"scalar",T:9
    }
    ])
  }
  static fromBinary(e, t){
