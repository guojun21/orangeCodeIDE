// Module: out-build/external/bufbuild/connect/code.js
// Offset: 26659784 (bundle byte offset)
// Size: 811 bytes
...
function Thn(n){
  const e=j0[n];
  return typeof e!="string"?n.toString():e[0].toLowerCase()+e.substring(1).replace(/[A-Z]/g, t=>"_"+t.toLowerCase())
}
var ytu=