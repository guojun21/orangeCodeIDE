...
pve(), $te(), vRc(), gRc(), (function(n){
  n[n.PROTO2=0]="PROTO2", n[n.PROTO3=1]="PROTO3", n[n.EDITIONS=2]="EDITIONS"
})(ike||(ike={
  ...
  constructor(e){
    super(), this.name="", this.fields=[], this.oneofs=[], this.options=[], this.syntax=ike.PROTO2, this.edition="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"fields",kind:"message",T:W1h,repeated:!0
    }, {
      no:3,name:"oneofs",kind:"scalar",T:9,repeated:!0
    }, {
      no:4,name:"options",kind:"message",T:Ibt,repeated:!0
    }, {
      no:5,name:"source_context",kind:"message",T:L9o
    }, {
      no:6,name:"syntax",kind:"enum",T:v.getEnumType(ike)
    }, {
  ...
  constructor(e){
    super(), this.kind=v5n.TYPE_UNKNOWN, this.cardinality=A5n.UNKNOWN, this.number=0, this.name="", this.typeUrl="", this.oneofIndex=0, this.packed=!1, this.options=[], this.jsonName="", this.defaultValue="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      no:1,name:"kind",kind:"enum",T:v.getEnumType(v5n)
    }, {
      no:2,name:"cardinality",kind:"enum",T:v.getEnumType(A5n)
    }, {
      ...
      no:9,name:"options",kind:"message",T:Ibt,repeated:!0
    }, {
  ...
  n[n.TYPE_UNKNOWN=0]="TYPE_UNKNOWN", n[n.TYPE_DOUBLE=1]="TYPE_DOUBLE", n[n.TYPE_FLOAT=2]="TYPE_FLOAT", n[n.TYPE_INT64=3]="TYPE_INT64", n[n.TYPE_UINT64=4]="TYPE_UINT64", n[n.TYPE_INT32=5]="TYPE_INT32", n[n.TYPE_FIXED64=6]="TYPE_FIXED64", n[n.TYPE_FIXED32=7]="TYPE_FIXED32", n[n.TYPE_BOOL=8]="TYPE_BOOL", n[n.TYPE_STRING=9]="TYPE_STRING", n[n.TYPE_GROUP=10]="TYPE_GROUP", n[n.TYPE_MESSAGE=11]="TYPE_MESSAGE", n[n.TYPE_BYTES=12]="TYPE_BYTES", n[n.TYPE_UINT32=13]="TYPE_UINT32", n[n.TYPE_ENUM=14]="TYPE_ENUM", n[n.TYPE_SFIXED32=15]="TYPE_SFIXED32", n[n.TYPE_SFIXED64=16]="TYPE_SFIXED64", n[n.TYPE_SINT32=17]="TYPE_SINT32", n[n.TYPE_SINT64=18]="TYPE_SINT64"
})(v5n||(v5n={
  ...
  n[n.UNKNOWN=0]="UNKNOWN", n[n.OPTIONAL=1]="OPTIONAL", n[n.REQUIRED=2]="REQUIRED", n[n.REPEATED=3]="REPEATED"
})(A5n||(A5n={
  ...
  constructor(e){
    super(), this.name="", this.enumvalue=[], this.options=[], this.syntax=ike.PROTO2, this.edition="", v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"enumvalue",kind:"message",T:Q1h,repeated:!0
    }, {
      no:3,name:"options",kind:"message",T:Ibt,repeated:!0
    }, {
      no:4,name:"source_context",kind:"message",T:L9o
    }, {
      no:5,name:"syntax",kind:"enum",T:v.getEnumType(ike)
    }, {
  ...
  constructor(e){
    super(), this.name="", this.number=0, this.options=[], v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"value",kind:"message",T:pRc
    }
    ])
  }
  static fromBinary(e, t){
