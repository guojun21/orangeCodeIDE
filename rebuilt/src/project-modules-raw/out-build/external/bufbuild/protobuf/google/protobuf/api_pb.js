...
$te(), j1h(), vRc(), pve(), upA=class hMi extends ie{
  constructor(e){
    super(), this.name="", this.methods=[], this.options=[], this.version="", this.mixins=[], this.syntax=ike.PROTO2, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:2,name:"methods",kind:"message",T:z1h,repeated:!0
    }, {
      ...
      no:6,name:"mixins",kind:"message",T:V1h,repeated:!0
    }, {
      no:7,name:"syntax",kind:"enum",T:v.getEnumType(ike)
    }
    ])
  }
  ...
  constructor(e){
    super(), this.name="", this.requestTypeUrl="", this.requestStreaming=!1, this.responseTypeUrl="", this.responseStreaming=!1, this.options=[], this.syntax=ike.PROTO2, v.util.initPartial(e, this)
  }
  static{
    this.runtime=v
  }
  ...
  static{
    this.fields=v.util.newFieldList(()=>[{
      ...
      no:6,name:"options",kind:"message",T:Ibt,repeated:!0
    }, {
      no:7,name:"syntax",kind:"enum",T:v.getEnumType(ike)
    }
    ])
