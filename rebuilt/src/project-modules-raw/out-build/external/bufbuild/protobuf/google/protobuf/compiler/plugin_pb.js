...
$te(), y9o(), f5n(), J1h=class nMi extends ie{
  constructor(e){
  ...
  constructor(e){
    super(), this.fileToGenerate=[], this.protoFile=[], this.sourceFileDescriptors=[], Rc.util.initPartial(e, this)
  }
  static{
    this.runtime=Rc
  }
  ...
  static{
    this.fields=Rc.util.newFieldList(()=>[{
      ...
      no:15,name:"proto_file",kind:"message",T:w9o,repeated:!0
    }, {
      no:17,name:"source_file_descriptors",kind:"message",T:w9o,repeated:!0
    }, {
      no:3,name:"compiler_version",kind:"message",T:J1h,opt:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  static{
    this.fields=Rc.util.newFieldList(()=>[{
      ...
      no:15,name:"file",kind:"message",T:G1h,repeated:!0
    }
    ])
  }
  static fromBinary(e, t){
  ...
  n[n.NONE=0]="NONE", n[n.PROTO3_OPTIONAL=1]="PROTO3_OPTIONAL", n[n.SUPPORTS_EDITIONS=2]="SUPPORTS_EDITIONS"
})(bRc||(bRc={
  ...
  static{
    this.fields=Rc.util.newFieldList(()=>[{
      ...
      no:16,name:"generated_code_info",kind:"message",T:M1h,opt:!0
    }
    ])
  }
  static fromBinary(e, t){
