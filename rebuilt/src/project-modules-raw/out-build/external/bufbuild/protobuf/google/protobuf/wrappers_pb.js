...
$te(), pve(), tke(), EKe(), jmA=class jCn extends ie{
  constructor(e){
    super(), this.value=0, v.util.initPartial(e, this)
  }
  toJson(e){
    return v.json.writeScalar(ud.DOUBLE, this.value, !0)
  }
  fromJson(e, t){
    try{
      ...
      throw i instanceof Error&&i.message.length>0&&(r+=`: ${i.message}`),new Error(r)
    }
    return this
  }
  static{
  ...
  toJson(e){
    return v.json.writeScalar(ud.FLOAT, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  constructor(e){
    super(), this.value=Eo.zero, v.util.initPartial(e, this)
  }
  toJson(e){
    return v.json.writeScalar(ud.INT64, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  toJson(e){
    return v.json.writeScalar(ud.UINT64, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  toJson(e){
    return v.json.writeScalar(ud.INT32, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  toJson(e){
    return v.json.writeScalar(ud.UINT32, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  toJson(e){
    return v.json.writeScalar(ud.BOOL, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  toJson(e){
    return v.json.writeScalar(ud.STRING, this.value, !0)
  }
  fromJson(e, t){
    try{
  ...
  toJson(e){
    return v.json.writeScalar(ud.BYTES, this.value, !0)
  }
  fromJson(e, t){
    try{
