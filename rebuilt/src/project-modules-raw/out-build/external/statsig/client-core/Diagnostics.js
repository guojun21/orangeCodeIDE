...
Obi=new Map, Lpa="start", Npa="end", GMg="statsig::diagnostics", lye={
  _getMarkers:n=>Obi.get(n), _markInitOverallStart:n=>{
    Phn(n, Rhn({
      
    }, Lpa, "overall"))
  }, _markInitOverallEnd:(n, e, t)=>{
    Phn(n, Rhn({
      success:e,error:e?void 0:{
    ...
    if(n&&typeof n=="object")return{
      code:Dtu(n,"code"),name:Dtu(n,"name"),message:Dtu(n,"message")
    }
  }, _getDiagnosticsData(n, e, t, i){
    return{
      success:n?.ok===!0,statusCode:n?.status,sdkRegion:n?.headers?.get("x-statsig-region"),isDelta:t.includes('"is_delta":true')===!0?!0:void 0,attempt:e,error:lye._formatError(i)
    }
    ...
    lye._clearMarkers(t);
    const o=eMA(n, {
      context:"initialize",markers:r.slice(),statsigOptions:i
    });
    return e.enqueue(o), s
  }
}
}
});
...
function QMg(n, e){
  const t=i=>Array.isArray(i)?"array":i===null?"null":typeof i;
  return t(n)===t(e)
}
var Rtu=