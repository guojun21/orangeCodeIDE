...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-tenth-export-delta-gate.json');
...
function main() {
  ...
  const expectedNormalizedBody = 'u0a = "Worktree chats require a single-root workspace. Remove additional workspace folders or open a single-folder workspace.";';
