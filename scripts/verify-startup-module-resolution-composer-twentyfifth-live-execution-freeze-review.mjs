...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-live-execution-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'composer-twentyfifth-live-execution-freeze-review',
    baselinePinned:
    ...
    provenPinned:
      ...
      && report.proven?.twentyfirstSingleLiveWaveId === 'DC25L'
    ...
    decisionPinned:
      ...
      && report.decision?.nextApprovedStep === 'composer-twentyfifth-live-execution-next-step-lock'
