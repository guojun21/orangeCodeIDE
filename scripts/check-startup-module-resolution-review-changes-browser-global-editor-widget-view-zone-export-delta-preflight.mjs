...
function main() {
  ...
  const selectedModules = contractPlan.globalEditorWidgetViewZoneContractPlan?.selectedModules ?? [];
  ...
  const report = {
    ...
    lane: 'browser',
    phase: 'browser-global-editor-widget-view-zone-export-delta-preflight',
