...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-batch-fallback-preflight.json');
...
function main() {
  ...
  const report = {
    ...
    lane: 'browser',
    phase: 'browser-batch-fallback-preflight',
