...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfourth-live-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      ...
      'do not switch to composer runner-ups before DC24L live outcome is frozen',
    ],
  };
