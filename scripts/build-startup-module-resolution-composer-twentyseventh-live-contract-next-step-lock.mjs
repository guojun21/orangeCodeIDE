...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyseventh-live-contract-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyseventh-live-execution',
      approvedCandidateOnly: 'out-build/vs/workbench/contrib/composer/browser/composerViews.js',
    ...
    stopConditions: [
      'do not discuss wider composer batch until DC27L live is executed and frozen',
      'do not reopen reviewChanges or browser lane expansion before DC27L live outcome is frozen',
    ],
  };
