...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysecond-runtime-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentysecond-live-admission-plan',
    ...
    stopConditions: [
      'do not discuss DC22L execution until DC22 dedicated no-op runtime is frozen and locked',
