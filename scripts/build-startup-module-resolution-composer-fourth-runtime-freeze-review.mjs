...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fourth-runtime-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    fourthNoOp: {
      ...
      waveId: fourthRuntimeGate.expectedWaveId ?? null,
    ...
    decision: {
      laneFrozen: true,
      laneState: 'contrib-composer-three-single-live-one-micro-batch-fourth-no-op-proven',
      nextApprovedStep: 'composer-fourth-runtime-next-step-lock',
