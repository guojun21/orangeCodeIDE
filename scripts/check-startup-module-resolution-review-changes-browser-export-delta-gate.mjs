...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-export-delta-gate.json');
...
function main() {
  ...
  const checks = {
    ...
    singleThinWrapperShape:
      sourceSummary.topLevelCalls.length === 1
      && inputSummary.topLevelCalls.length === 1
      && sourceSummary.topLevelCalls[0] === inputSummary.topLevelCalls[0],
  };
