...
const ELEVENTH_LIVE_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-sixteenth-module-resolution-live-gate.json');
const ACCEPT_PATH = path.join(ROOT, 'mapped', 'accept-latest.json');
const QUALITY_PATH = path.join(ROOT, 'mapped', 'quality-report.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-sixteenth-live-execution-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    phase: 'composer-sixteenth-live-execution-freeze-review',
    sources: {
      sixteenthLiveContractFreezeReview: normalizePath(path.relative(ROOT, ELEVENTH_LIVE_CONTRACT_FREEZE_REVIEW_PATH)),
      sixteenthLiveGate: normalizePath(path.relative(ROOT, ELEVENTH_LIVE_GATE_PATH)),
    ...
    proven: {
      ...
      sixteenthSingleLiveModuleId: moduleId,
      sixteenthSingleLiveWaveId: liveGate.expectedWaveId ?? null,
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-sixteenth-live-execution-next-step-lock',
