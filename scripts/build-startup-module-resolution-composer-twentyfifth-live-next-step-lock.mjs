...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-live-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      ...
      approvedCandidateOnly: 'out-build/vs/workbench/contrib/composer/browser/browserPlaceholderPages.js',
    ...
    stopConditions: [
      'do not discuss wider composer batch until DC25L live is executed and frozen',
      'do not switch to composer runner-ups before DC25L live outcome is frozen',
    ],
  };
