...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyseventh-runtime-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyseventh-live-admission-plan',
    ...
    stopConditions: [
      'do not discuss DC27L execution until DC27 dedicated no-op runtime is frozen and locked',
