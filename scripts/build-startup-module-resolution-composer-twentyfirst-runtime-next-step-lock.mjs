...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfirst-runtime-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyfirst-live-admission-plan',
    ...
    stopConditions: [
      'do not discuss DC21L execution until DC21 dedicated no-op runtime is frozen and locked',
