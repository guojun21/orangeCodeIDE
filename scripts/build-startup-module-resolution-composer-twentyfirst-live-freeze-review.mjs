...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfirst-live-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-twentyfirst-live-next-step-lock',
