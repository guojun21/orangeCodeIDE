...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-third-export-delta-gate.json');
...
function main() {
  ...
  const checks = {
    ...
    helperInitShape:
      ...
      && sourceSummary.topLevelCalls[0] === 'gNe'
      && inputSummary.topLevelCalls[0] === 'gNe',
  };
