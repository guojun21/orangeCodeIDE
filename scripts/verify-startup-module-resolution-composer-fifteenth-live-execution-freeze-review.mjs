...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fifteenth-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fifteenth-live-execution-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'composer-fifteenth-live-execution-freeze-review',
    baselinePinned:
    ...
    provenPinned:
      ...
      && report.proven?.fifteenthSingleLiveModuleId === moduleId
      && report.proven?.fifteenthSingleLiveWaveId === 'DC15L'
    ...
    decisionPinned:
      ...
      && report.decision?.nextApprovedStep === 'composer-fifteenth-live-execution-next-step-lock'
