...
const ELEVENTH_LIVE_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-seventeenth-module-resolution-live-gate.json');
const ACCEPT_PATH = path.join(ROOT, 'mapped', 'accept-latest.json');
const QUALITY_PATH = path.join(ROOT, 'mapped', 'quality-report.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-seventeenth-live-execution-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    phase: 'composer-seventeenth-live-execution-freeze-review',
    sources: {
      seventeenthLiveContractFreezeReview: normalizePath(path.relative(ROOT, ELEVENTH_LIVE_CONTRACT_FREEZE_REVIEW_PATH)),
      seventeenthLiveGate: normalizePath(path.relative(ROOT, ELEVENTH_LIVE_GATE_PATH)),
    ...
    proven: {
      ...
      seventeenthSingleLiveModuleId: moduleId,
      seventeenthSingleLiveWaveId: liveGate.expectedWaveId ?? null,
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-seventeenth-live-execution-next-step-lock',
