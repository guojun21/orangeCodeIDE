...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-runtime-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyfifth-live-admission-plan',
    ...
    stopConditions: [
      'do not discuss DC25L execution until DC25 dedicated no-op runtime is frozen and locked',
