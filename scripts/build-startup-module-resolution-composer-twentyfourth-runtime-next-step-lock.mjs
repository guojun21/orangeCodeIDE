...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfourth-runtime-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyfourth-live-admission-plan',
    ...
    stopConditions: [
      'do not discuss DC24L execution until DC24 dedicated no-op runtime is frozen and locked',
