...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-third-live-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    batchEligibilityGate: thirdLiveAdmissionPlan.batchEligibilityGate ?? {},
    ...
    decision: {
      laneFrozen: true,
      laneState: 'two-single-live-proven-third-live-admission-planned-still-no-batch',
      nextApprovedStep: 'browser-third-live-next-step-lock',
