...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentythird-live-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-twentythird-live-next-step-lock',
