...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-sticky-disable-audit.json');
...
function main() {
  ...
  const checks = {
    ...
    runtimeStickyDisabledCountZero: (diagnostics?.counters?.stickyDisabledCount ?? -1) === 0,
    runtimeStickyDisabledModulesEmpty:
