...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-thirteenth-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-thirteenth-live-execution-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'composer-thirteenth-live-execution-freeze-review',
    baselinePinned:
    ...
    provenPinned:
      ...
      && report.proven?.thirteenthSingleLiveModuleId === moduleId
      && report.proven?.thirteenthSingleLiveWaveId === 'DC13L'
    ...
    decisionPinned:
      ...
      && report.decision?.nextApprovedStep === 'composer-thirteenth-live-execution-next-step-lock'
