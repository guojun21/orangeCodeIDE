...
const ELEVENTH_LIVE_EXECUTION_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentythird-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentythird-live-execution-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    phase: 'composer-twentythird-live-execution-next-step-lock',
    sources: {
