...
const COMPOSER_ELEVENTH_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyseventh-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyseventh-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      'do not discuss DC27L until DC27A dedicated no-op runtime gate completes',
