...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-batch-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-batch-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'browser-batch-freeze-review',
    baselinePinned:
    ...
    decisionPinned:
      ...
      && report.decision?.laneState === 'three-single-live-proven-batch-admission-planned'
      && report.decision?.nextApprovedStep === 'browser-batch-next-step-lock'
    ...
    minimumWinPinned:
      ...
      && minimumWin.mustVerify.includes('startup-module-resolution-review-changes-browser-batch-freeze-review-verify.json'),
    scopeBoundaryPinned:
