...
const CONTRACT_PATH = path.join(ROOT, 'mapped', 'contrib-composer-seventh-module-resolution-live-contract.json');
const RUNTIME_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-seventh-module-resolution-runtime-gate.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-seventh-sticky-disable-preflight.json');
