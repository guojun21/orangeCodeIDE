...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-broader-editor-widget-view-zone-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-broader-editor-widget-view-zone-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'browser-broader-editor-widget-view-zone-freeze-review',
    baselinePinned:
    ...
    surfacePinned:
      ...
      && report.admittedSurface.selectedModules.length === 3
    ...
    decisionPinned:
      ...
      && report.decision?.laneState === 'five-single-live-proven-first-and-second-and-third-batch-live-proven-component-widget-template-live-proven-heavier-ui-live-proven-broader-editor-widget-view-zone-admission-planned'
      && report.decision?.nextApprovedStep === 'browser-broader-editor-widget-view-zone-next-step-lock'
