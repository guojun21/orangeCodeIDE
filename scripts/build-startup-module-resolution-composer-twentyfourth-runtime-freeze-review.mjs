...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfourth-runtime-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-twentyfourth-runtime-next-step-lock',
