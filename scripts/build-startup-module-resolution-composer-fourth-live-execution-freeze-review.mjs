...
const FOURTH_LIVE_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-fourth-module-resolution-live-gate.json');
const ACCEPT_PATH = path.join(ROOT, 'mapped', 'accept-latest.json');
const QUALITY_PATH = path.join(ROOT, 'mapped', 'quality-report.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fourth-live-execution-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    phase: 'composer-fourth-live-execution-freeze-review',
    sources: {
    ...
    proven: {
      ...
      fourthSingleLiveModuleId: moduleId,
    ...
    decision: {
      laneFrozen: true,
      laneState: 'contrib-composer-four-single-live-one-micro-batch-proven',
      nextApprovedStep: 'composer-fourth-live-execution-next-step-lock',
