...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysecond-live-contract-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentysecond-live-execution',
      approvedCandidateOnly: 'out-build/vs/workbench/contrib/composer/browser/browserScreenshotService.js',
    ...
    stopConditions: [
      'do not discuss wider composer batch until DC22L live is executed and frozen',
      'do not reopen reviewChanges or browser lane expansion before DC22L live outcome is frozen',
    ],
  };
