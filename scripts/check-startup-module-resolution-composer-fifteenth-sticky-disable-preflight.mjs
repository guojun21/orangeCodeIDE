...
const CONTRACT_PATH = path.join(ROOT, 'mapped', 'contrib-composer-fifteenth-module-resolution-live-contract.json');
const RUNTIME_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-fifteenth-module-resolution-runtime-gate.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fifteenth-sticky-disable-preflight.json');
