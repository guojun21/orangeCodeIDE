...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentythird-live-contract-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentythird-live-execution',
    ...
    stopConditions: [
      'do not discuss wider composer batch until DC23L live is executed and frozen',
      'do not reopen reviewChanges or browser lane expansion before DC23L live outcome is frozen',
    ],
  };
