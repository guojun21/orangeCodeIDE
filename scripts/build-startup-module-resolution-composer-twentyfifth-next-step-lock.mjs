...
const COMPOSER_ELEVENTH_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      'do not discuss DC25L until DC25A dedicated no-op runtime gate completes',
