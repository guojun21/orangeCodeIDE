...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysecond-live-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      ...
      'do not switch to composer runner-ups before DC22L live outcome is frozen',
    ],
  };
