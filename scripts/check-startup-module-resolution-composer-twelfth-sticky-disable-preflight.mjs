...
const CONTRACT_PATH = path.join(ROOT, 'mapped', 'contrib-composer-twelfth-module-resolution-live-contract.json');
const RUNTIME_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-twelfth-module-resolution-runtime-gate.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twelfth-sticky-disable-preflight.json');
