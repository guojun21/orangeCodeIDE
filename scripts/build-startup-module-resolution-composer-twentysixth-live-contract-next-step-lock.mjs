...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysixth-live-contract-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentysixth-live-execution',
    ...
    stopConditions: [
      'do not discuss wider composer batch until DC26L live is executed and frozen',
      'do not reopen reviewChanges or browser lane expansion before DC26L live outcome is frozen',
    ],
  };
