...
function main() {
  ...
  const selectedModules = contractPlan.broaderEditorWidgetViewZoneContractPlan?.selectedModules ?? [];
  ...
  const report = {
    ...
    lane: 'browser',
    phase: 'browser-broader-editor-widget-view-zone-export-delta-preflight',
