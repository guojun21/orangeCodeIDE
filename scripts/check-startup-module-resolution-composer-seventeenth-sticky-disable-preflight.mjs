...
const CONTRACT_PATH = path.join(ROOT, 'mapped', 'contrib-composer-seventeenth-module-resolution-live-contract.json');
const RUNTIME_GATE_PATH = path.join(ROOT, 'mapped', 'contrib-composer-seventeenth-module-resolution-runtime-gate.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-seventeenth-sticky-disable-preflight.json');
