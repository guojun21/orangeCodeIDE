...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfourth-live-contract-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyfourth-live-execution',
      approvedCandidateOnly: 'out-build/vs/workbench/contrib/composer/browser/composerWakelockManager.js',
    ...
    stopConditions: [
      'do not discuss wider composer batch until DC24L live is executed and frozen',
      'do not reopen reviewChanges or browser lane expansion before DC24L live outcome is frozen',
    ],
  };
