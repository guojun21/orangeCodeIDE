...
const COMPOSER_ELEVENTH_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysecond-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysecond-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      'do not discuss DC22L until DC22A dedicated no-op runtime gate completes',
