...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentythird-runtime-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentythird-live-admission-plan',
    ...
    stopConditions: [
      'do not discuss DC23L execution until DC23 dedicated no-op runtime is frozen and locked',
