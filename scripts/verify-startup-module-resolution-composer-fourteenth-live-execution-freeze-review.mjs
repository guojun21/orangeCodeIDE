...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fourteenth-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-fourteenth-live-execution-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'composer-fourteenth-live-execution-freeze-review',
    baselinePinned:
    ...
    provenPinned:
      ...
      && report.proven?.fourteenthSingleLiveModuleId === moduleId
      && report.proven?.fourteenthSingleLiveWaveId === 'DC14L'
    ...
    decisionPinned:
      ...
      && report.decision?.nextApprovedStep === 'composer-fourteenth-live-execution-next-step-lock'
