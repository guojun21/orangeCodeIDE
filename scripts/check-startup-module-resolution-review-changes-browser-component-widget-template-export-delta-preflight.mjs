...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-component-widget-template-export-delta-preflight.json');
...
function main() {
  ...
  const selectedModules = contractPlan.componentWidgetTemplateContractPlan?.selectedModules ?? [];
  ...
  const report = {
    ...
    lane: 'browser',
    phase: 'browser-component-widget-template-export-delta-preflight',
