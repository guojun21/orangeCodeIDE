...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-live-contract-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      nextApprovedAction: 'composer-twentyfifth-live-execution',
    ...
    stopConditions: [
      ...
      'do not reopen reviewChanges or browser lane expansion before DC25L live outcome is frozen',
    ],
  };
