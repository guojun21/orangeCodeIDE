...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfifth-live-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-twentyfifth-live-next-step-lock',
