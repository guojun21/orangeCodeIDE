...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-review-changes-browser-second-export-delta-gate.json');
...
function main() {
  ...
  const checks = {
    ...
    thinAssignmentShape:
      ...
      && sourceSummary.byteLength === inputSummary.byteLength,
  };
