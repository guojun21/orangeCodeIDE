...
const COMPOSER_ELEVENTH_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfirst-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfirst-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      'do not discuss DC21L until DC21A dedicated no-op runtime gate completes',
