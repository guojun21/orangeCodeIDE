...
const THIRD_LIVE_EXECUTION_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-third-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-third-live-execution-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    phase: 'composer-third-live-execution-next-step-lock',
    sources: {
    ...
    decision: {
      ...
      composerLaneFreezeMayStartOnlyAfterThirdLiveFreeze: true,
