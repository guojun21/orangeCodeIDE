...
const COMPOSER_ELEVENTH_FREEZE_REVIEW_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfourth-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentyfourth-next-step-lock.json');
...
function main() {
  ...
  const report = {
    ...
    stopConditions: [
      'do not discuss DC24L until DC24A dedicated no-op runtime gate completes',
