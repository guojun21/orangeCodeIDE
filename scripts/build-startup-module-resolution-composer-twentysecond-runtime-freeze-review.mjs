...
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentysecond-runtime-freeze-review.json');
...
function main() {
  ...
  const report = {
    ...
    decision: {
      ...
      nextApprovedStep: 'composer-twentysecond-runtime-next-step-lock',
