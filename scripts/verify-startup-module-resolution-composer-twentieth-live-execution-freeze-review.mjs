...
const INPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentieth-live-execution-freeze-review.json');
const OUTPUT_PATH = path.join(ROOT, 'mapped', 'startup-module-resolution-composer-twentieth-live-execution-freeze-review-verify.json');
...
function main() {
  ...
  const checks = {
    ...
    phasePinned: report.phase === 'composer-twentieth-live-execution-freeze-review',
    baselinePinned:
    ...
    provenPinned:
      ...
      && report.proven?.twentiethSingleLiveModuleId === moduleId
      && report.proven?.twentiethSingleLiveWaveId === 'DC20L'
    ...
    decisionPinned:
      ...
      && report.decision?.nextApprovedStep === 'composer-twentieth-live-execution-next-step-lock'
